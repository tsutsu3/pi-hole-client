...
void main() async {
  ...
  group('updateGravity', () {
    ...
    test('should return notSupported when server is v5', () async {
      final mockClient = MockClient();
      final apiGateway = ApiGatewayV5(server, client: mockClient);
      final responseStream = apiGateway.updateGravity();
  ...
  group('removeMessage', () {
    ...
    test('should return notSupported when server is v5', () async {
      final mockClient = MockClient();
      final apiGateway = ApiGatewayV5(server, client: mockClient);
      final response = await apiGateway.removeMessage(3);
  ...
  group('deleteLocalDns', () {
    ...
    test('should return notSupported when server is v5', () async {
      final mockClient = MockClient();
      final apiGateway = ApiGatewayV5(server, client: mockClient);
      final response = await apiGateway.deleteLocalDns(
        ip: '192.168.1.2',
        name: 'device',
      );
  ...
  group('addLocalDns', () {
    ...
    test('should return notSupported when server is v5', () async {
      final mockClient = MockClient();
      final apiGateway = ApiGatewayV5(server, client: mockClient);
      final response = await apiGateway.addLocalDns(
        ip: '192.168.1.2',
        name: 'device',
      );
  ...
  group('deleteDhcp', () {
    ...
    test('should return notSupported when server is v5', () async {
      final mockClient = MockClient();
      final apiGateway = ApiGatewayV5(server, client: mockClient);
      final response = await apiGateway.deleteDhcp('192.168.100.100');
