...
void main() {
  ...
  group('FiltersV5 – setRequestStatus', () {
    late FiltersV5 f;
    ...
    test('allowed and blocked selections are disjoint', () {
      f.setRequestStatus(RequestStatus.allowed);
      final allowed = Set.of(f.statusSelected);
      f.setRequestStatus(RequestStatus.blocked);
      final blocked = Set.of(f.statusSelected);
      expect(allowed.intersection(blocked), isEmpty);
    });
  });
  ...
  group('FiltersV5 – client filters', () {
    late FiltersV5 f;
