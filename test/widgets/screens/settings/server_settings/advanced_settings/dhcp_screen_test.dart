...
void main() async {
  ...
  group('Dhcp Screen tests', () {
    ...
    testWidgets('should show error screen when fetching sessions fails', (
      ...
      when(
        testSetup.mockApiGatewayV6.getDhcps(),
      ).thenAnswer((_) async => DhcpResponse(result: APiResponseType.error));
      ...
      await tester.pumpWidget(testSetup.buildTestWidget(const DhcpScreen()));
