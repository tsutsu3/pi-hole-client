...
void main() async {
  ...
  group('Settings Screen Widget Tests', () {
    ...
    testWidgets('should show V6 server settings screen', (
      WidgetTester tester,
    ) async {
      ...
      await tester.pumpWidget(
        testSetup.buildTestWidget(const ServerInfoScreen()),
      );
    ...
    testWidgets('should show error message screen', (
      WidgetTester tester,
    ) async {
      tester.view.physicalSize = const Size(1080, 2400);
      tester.view.devicePixelRatio = 2.0;
      ...
      when(
        testSetup.mockApiGatewayV6.fetchAllServerInfo(),
    ...
    testWidgets('should show skelton when Future is not complete', (
      WidgetTester tester,
    ) async {
      tester.view.physicalSize = const Size(1080, 2400);
      tester.view.devicePixelRatio = 2.0;
    ...
    testWidgets('should show error when fetch fails', (
      WidgetTester tester,
    ) async {
      tester.view.physicalSize = const Size(1080, 2400);
      tester.view.devicePixelRatio = 2.0;
      ...
      when(testSetup.mockApiGatewayV6.fetchAllServerInfo()).thenAnswer(
        (_) async => PiHoleServerInfoResponse(result: APiResponseType.error),
      );
  ...
  group('Settings Screen Widget Tests', () {
    ...
    testWidgets('should show V5 server settings screen', (
      WidgetTester tester,
    ) async {
      tester.view.physicalSize = const Size(1080, 2400);
      tester.view.devicePixelRatio = 2.0;
