...
abstract class Routes {
  ...
  static const settingsServerSubscriptions = 'settings/server/subscriptions';
  static const settingsServerSubscriptionsDetails =
      'settings/server/subscriptions/details';
