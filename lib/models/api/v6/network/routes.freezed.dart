...
mixin _$Routes {
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(routes), took);
...
abstract mixin class $RoutesCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<RouteData> routes, double took});
}
...
class _Routes implements Routes {
  const _Routes({required final List<RouteData> routes, required this.took})
      : _routes = routes;
  ...
  @override
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_routes), took);
