...
class DomainRepositoryV5 implements DomainRepository {
  DomainRepositoryV5({
    ...
    return runWithResultRetry<DomainLists>(
      action: () async {
        final results = await Future.wait([
          _client.getDomains(_token, domainType: V5DomainType.white),
          _client.getDomains(_token, domainType: V5DomainType.regex_white),
          _client.getDomains(_token, domainType: V5DomainType.black),
          _client.getDomains(_token, domainType: V5DomainType.regex_black),
        ]);
