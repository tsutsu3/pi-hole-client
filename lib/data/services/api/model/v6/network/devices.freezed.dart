...
mixin _$Devices {
 ...
 List<DeviceData> get devices; double get took;
...
@useResult
$Res call({
 List<DeviceData> devices, double took
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<DeviceData> devices,  double took)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Devices() when $default != null:
return $default(_that.devices,_that.took);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<DeviceData> devices,  double took)  $default,) {final _that = this;
switch (_that) {
case _Devices():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<DeviceData> devices,  double took)?  $default,) {final _that = this;
switch (_that) {
case _Devices() when $default != null:
return $default(_that.devices,_that.took);case _:
  return null;
...
@override List<DeviceData> get devices {
...
/// Create a copy of Devices
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? devices = null,Object? took = null,}) {
...
mixin _$DeviceData {
 ...
 int get id; String get hwaddr; String get interface; int get firstSeen; int get lastQuery; int get numQueries; List<DeviceIp> get ips; String? get macVendor;
...
@useResult
$Res call({
 int id, String hwaddr, String interface, int firstSeen, int lastQuery, int numQueries, List<DeviceIp> ips, String? macVendor
});
...
as int,numQueries: null == numQueries ? _self.numQueries : numQueries // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String hwaddr,  String interface,  int firstSeen,  int lastQuery,  int numQueries,  List<DeviceIp> ips,  String? macVendor)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DeviceData() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String hwaddr,  String interface,  int firstSeen,  int lastQuery,  int numQueries,  List<DeviceIp> ips,  String? macVendor)  $default,) {final _that = this;
switch (_that) {
case _DeviceData():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String hwaddr,  String interface,  int firstSeen,  int lastQuery,  int numQueries,  List<DeviceIp> ips,  String? macVendor)?  $default,) {final _that = this;
switch (_that) {
case _DeviceData() when $default != null:
return $default(_that.id,_that.hwaddr,_that.interface,_that.firstSeen,_that.lastQuery,_that.numQueries,_that.ips,_that.macVendor);case _:
  return null;
...
@override final  int firstSeen;
@override final  int lastQuery;
...
mixin _$DeviceIp {
 ...
 String get ip; int get lastSeen; int get nameUpdated; String? get name;
...
@useResult
$Res call({
 String ip, int lastSeen, int nameUpdated, String? name
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String ip,  int lastSeen,  int nameUpdated,  String? name)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DeviceIp() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String ip,  int lastSeen,  int nameUpdated,  String? name)  $default,) {final _that = this;
switch (_that) {
case _DeviceIp():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String ip,  int lastSeen,  int nameUpdated,  String? name)?  $default,) {final _that = this;
switch (_that) {
case _DeviceIp() when $default != null:
return $default(_that.ip,_that.lastSeen,_that.nameUpdated,_that.name);case _:
  return null;
...
@override final  int nameUpdated;
