...
mixin _$Lists {
 ...
 List<ListItem> get lists; double get took; Processed? get processed;
/// Create a copy of Lists
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$ListsCopyWith<Lists> get copyWith => _$ListsCopyWithImpl<Lists>(this as Lists, _$identity);
...
abstract mixin class $ListsCopyWith<$Res>  {
  factory $ListsCopyWith(Lists value, $Res Function(Lists) _then) = _$ListsCopyWithImpl;
@useResult
$Res call({
 List<ListItem> lists, double took, Processed? processed
});
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _Lists value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _Lists value)  $default,){
final _that = this;
switch (_that) {
case _Lists():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _Lists value)?  $default,){
final _that = this;
switch (_that) {
case _Lists() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<ListItem> lists,  double took,  Processed? processed)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Lists() when $default != null:
return $default(_that.lists,_that.took,_that.processed);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<ListItem> lists,  double took,  Processed? processed)  $default,) {final _that = this;
switch (_that) {
case _Lists():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<ListItem> lists,  double took,  Processed? processed)?  $default,) {final _that = this;
switch (_that) {
case _Lists() when $default != null:
return $default(_that.lists,_that.took,_that.processed);case _:
  return null;
...
@override List<ListItem> get lists {
...
@pragma('vm:prefer-inline')
_$ListsCopyWith<_Lists> get copyWith => __$ListsCopyWithImpl<_Lists>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ListsToJson(this, );
}
...
abstract mixin class _$ListsCopyWith<$Res> implements $ListsCopyWith<$Res> {
  factory _$ListsCopyWith(_Lists value, $Res Function(_Lists) _then) = __$ListsCopyWithImpl;
@override @useResult
$Res call({
 List<ListItem> lists, double took, Processed? processed
});
...
/// Create a copy of Lists
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? lists = null,Object? took = null,Object? processed = freezed,}) {
  return _then(_Lists(
...
mixin _$ListItem {
 ...
 String get address; String get type; List<int> get groups; bool get enabled; int get id;@JsonKey(name: 'date_added') int get dateAdded;@JsonKey(name: 'date_modified') int get dateModified;@JsonKey(name: 'date_updated') int get dateUpdated; int get number;@JsonKey(name: 'invalid_domains') int get invalidDomains;@JsonKey(name: 'abp_entries') int get abpEntries; int get status; String? get comment;
...
@useResult
$Res call({
 String address, String type, List<int> groups, bool enabled, int id,@JsonKey(name: 'date_added') int dateAdded,@JsonKey(name: 'date_modified') int dateModified,@JsonKey(name: 'date_updated') int dateUpdated, int number,@JsonKey(name: 'invalid_domains') int invalidDomains,@JsonKey(name: 'abp_entries') int abpEntries, int status, String? comment
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String address,  String type,  List<int> groups,  bool enabled,  int id, @JsonKey(name: 'date_added')  int dateAdded, @JsonKey(name: 'date_modified')  int dateModified, @JsonKey(name: 'date_updated')  int dateUpdated,  int number, @JsonKey(name: 'invalid_domains')  int invalidDomains, @JsonKey(name: 'abp_entries')  int abpEntries,  int status,  String? comment)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ListItem() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String address,  String type,  List<int> groups,  bool enabled,  int id, @JsonKey(name: 'date_added')  int dateAdded, @JsonKey(name: 'date_modified')  int dateModified, @JsonKey(name: 'date_updated')  int dateUpdated,  int number, @JsonKey(name: 'invalid_domains')  int invalidDomains, @JsonKey(name: 'abp_entries')  int abpEntries,  int status,  String? comment)  $default,) {final _that = this;
switch (_that) {
case _ListItem():
...
/// Create a copy of ListItem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? address = null,Object? type = null,Object? groups = null,Object? enabled = null,Object? id = null,Object? dateAdded = null,Object? dateModified = null,Object? dateUpdated = null,Object? number = null,Object? invalidDomains = null,Object? abpEntries = null,Object? status = null,Object? comment = freezed,}) {
...
mixin _$Processed {
 ...
 List<SuccessItem> get success; List<ErrorItem> get errors;
...
@useResult
$Res call({
 List<SuccessItem> success, List<ErrorItem> errors
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<SuccessItem> success,  List<ErrorItem> errors)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Processed() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<SuccessItem> success,  List<ErrorItem> errors)  $default,) {final _that = this;
switch (_that) {
case _Processed():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<SuccessItem> success,  List<ErrorItem> errors)?  $default,) {final _that = this;
switch (_that) {
case _Processed() when $default != null:
return $default(_that.success,_that.errors);case _:
  return null;
...
@override List<SuccessItem> get success {
...
@override List<ErrorItem> get errors {
...
as List<SuccessItem>,errors: null == errors ? _self._errors : errors // ignore: cast_nullable_to_non_nullable
as List<ErrorItem>,
  ));
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$SuccessItemCopyWith<SuccessItem> get copyWith => _$SuccessItemCopyWithImpl<SuccessItem>(this as SuccessItem, _$identity);
...
abstract mixin class $SuccessItemCopyWith<$Res>  {
  factory $SuccessItemCopyWith(SuccessItem value, $Res Function(SuccessItem) _then) = _$SuccessItemCopyWithImpl;
@useResult
$Res call({
 String item
});
...
/// @nodoc
class _$SuccessItemCopyWithImpl<$Res>
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _SuccessItem value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _SuccessItem value)  $default,){
final _that = this;
switch (_that) {
case _SuccessItem():
return $default(_that);}
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _SuccessItem value)?  $default,){
final _that = this;
switch (_that) {
case _SuccessItem() when $default != null:
return $default(_that);case _:
...
class _SuccessItem implements SuccessItem {
  ...
  factory _SuccessItem.fromJson(Map<String, dynamic> json) => _$SuccessItemFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$SuccessItemCopyWith<_SuccessItem> get copyWith => __$SuccessItemCopyWithImpl<_SuccessItem>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$SuccessItemToJson(this, );
}
...
/// @nodoc
abstract mixin class _$SuccessItemCopyWith<$Res> implements $SuccessItemCopyWith<$Res> {
  factory _$SuccessItemCopyWith(_SuccessItem value, $Res Function(_SuccessItem) _then) = __$SuccessItemCopyWithImpl;
@override @useResult
$Res call({
 String item
});
...
/// @nodoc
class __$SuccessItemCopyWithImpl<$Res>
    implements _$SuccessItemCopyWith<$Res> {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ErrorItem value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ErrorItem value)  $default,){
final _that = this;
switch (_that) {
case _ErrorItem():
return $default(_that);}
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ErrorItem value)?  $default,){
final _that = this;
switch (_that) {
case _ErrorItem() when $default != null:
return $default(_that);case _:
