...
_SuccessItem _$SuccessItemFromJson(Map<String, dynamic> json) =>
    _SuccessItem(item: json['item'] as String);

Map<String, dynamic> _$SuccessItemToJson(_SuccessItem instance) =>
    <String, dynamic>{'item': instance.item};

_ErrorItem _$ErrorItemFromJson(Map<String, dynamic> json) =>
    _ErrorItem(item: json['item'] as String, error: json['error'] as String);
