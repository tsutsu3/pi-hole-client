...
mixin _$Blocking {
 ...
 String get blocking; int? get timer; double get took;
...
@useResult
$Res call({
 String blocking, int? timer, double took
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String blocking,  int? timer,  double took)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Blocking() when $default != null:
return $default(_that.blocking,_that.timer,_that.took);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String blocking,  int? timer,  double took)  $default,) {final _that = this;
switch (_that) {
case _Blocking():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String blocking,  int? timer,  double took)?  $default,) {final _that = this;
switch (_that) {
case _Blocking() when $default != null:
return $default(_that.blocking,_that.timer,_that.took);case _:
  return null;
...
/// Create a copy of Blocking
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? blocking = null,Object? timer = freezed,Object? took = null,}) {
