...
_BiosInfo _$BiosInfoFromJson(Map<String, dynamic> json) =>
    _BiosInfo(vendor: json['vendor'] as String?);
...
_SystemInfo _$SystemInfoFromJson(Map<String, dynamic> json) =>
    _SystemInfo(vendor: json['vendor'] as String?);
