...
@JsonKey(name: 'remote_addr') String get remoteAddr;@JsonKey(name: 'http_version') String get httpVersion; String get method; List<Header> get headers; double get took;
...
@useResult
$Res call({
@JsonKey(name: 'remote_addr') String remoteAddr,@JsonKey(name: 'http_version') String httpVersion, String method, List<Header> headers, double took
});
...
as List<Header>,took: null == took ? _self.took : took // ignore: cast_nullable_to_non_nullable
as double,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'remote_addr')  String remoteAddr, @JsonKey(name: 'http_version')  String httpVersion,  String method,  List<Header> headers,  double took)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _InfoClient() when $default != null:
return $default(_that.remoteAddr,_that.httpVersion,_that.method,_that.headers,_that.took);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'remote_addr')  String remoteAddr, @JsonKey(name: 'http_version')  String httpVersion,  String method,  List<Header> headers,  double took)  $default,) {final _that = this;
switch (_that) {
case _InfoClient():
return $default(_that.remoteAddr,_that.httpVersion,_that.method,_that.headers,_that.took);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'remote_addr')  String remoteAddr, @JsonKey(name: 'http_version')  String httpVersion,  String method,  List<Header> headers,  double took)?  $default,) {final _that = this;
switch (_that) {
case _InfoClient() when $default != null:
return $default(_that.remoteAddr,_that.httpVersion,_that.method,_that.headers,_that.took);case _:
  return null;
...
/// Create a copy of InfoClient
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? remoteAddr = null,Object? httpVersion = null,Object? method = null,Object? headers = null,Object? took = null,}) {
