...
mixin _$History {
 ...
 List<HistoryData> get history; double get took;
...
@useResult
$Res call({
 List<HistoryData> history, double took
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<HistoryData> history,  double took)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _History() when $default != null:
return $default(_that.history,_that.took);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<HistoryData> history,  double took)  $default,) {final _that = this;
switch (_that) {
case _History():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<HistoryData> history,  double took)?  $default,) {final _that = this;
switch (_that) {
case _History() when $default != null:
return $default(_that.history,_that.took);case _:
  return null;
...
@override List<HistoryData> get history {
...
/// Create a copy of History
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? history = null,Object? took = null,}) {
...
mixin _$HistoryData {
 ...
 double get timestamp; int get total; int get cached; int get blocked; int get forwarded;
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( double timestamp,  int total,  int cached,  int blocked,  int forwarded)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _HistoryData() when $default != null:
return $default(_that.timestamp,_that.total,_that.cached,_that.blocked,_that.forwarded);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( double timestamp,  int total,  int cached,  int blocked,  int forwarded)  $default,) {final _that = this;
switch (_that) {
case _HistoryData():
return $default(_that.timestamp,_that.total,_that.cached,_that.blocked,_that.forwarded);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( double timestamp,  int total,  int cached,  int blocked,  int forwarded)?  $default,) {final _that = this;
switch (_that) {
case _HistoryData() when $default != null:
return $default(_that.timestamp,_that.total,_that.cached,_that.blocked,_that.forwarded);case _:
  return null;
...
class _HistoryData implements HistoryData {
  const _HistoryData({required this.timestamp, required this.total, required this.cached, required this.blocked, required this.forwarded});
...
/// Create a copy of HistoryData
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? timestamp = null,Object? total = null,Object? cached = null,Object? blocked = null,Object? forwarded = null,}) {
...
mixin _$HistoryClients {
 ...
 Map<String, Client> get clients; List<HistoryEntry> get history; double get took;
/// Create a copy of HistoryClients
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$HistoryClientsCopyWith<HistoryClients> get copyWith => _$HistoryClientsCopyWithImpl<HistoryClients>(this as HistoryClients, _$identity);
...
abstract mixin class $HistoryClientsCopyWith<$Res>  {
  factory $HistoryClientsCopyWith(HistoryClients value, $Res Function(HistoryClients) _then) = _$HistoryClientsCopyWithImpl;
@useResult
$Res call({
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _HistoryClients value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _HistoryClients value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _HistoryClients value)?  $default,){
final _that = this;
switch (_that) {
case _HistoryClients() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Map<String, Client> clients,  List<HistoryEntry> history,  double took)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _HistoryClients() when $default != null:
return $default(_that.clients,_that.history,_that.took);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Map<String, Client> clients,  List<HistoryEntry> history,  double took)  $default,) {final _that = this;
switch (_that) {
case _HistoryClients():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( Map<String, Client> clients,  List<HistoryEntry> history,  double took)?  $default,) {final _that = this;
switch (_that) {
case _HistoryClients() when $default != null:
return $default(_that.clients,_that.history,_that.took);case _:
  return null;
...
@override Map<String, Client> get clients {
...
@override List<HistoryEntry> get history {
  if (_history is EqualUnmodifiableListView) return _history;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_history);
}
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$HistoryClientsCopyWith<_HistoryClients> get copyWith => __$HistoryClientsCopyWithImpl<_HistoryClients>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$HistoryClientsToJson(this, );
}
...
/// @nodoc
abstract mixin class _$HistoryClientsCopyWith<$Res> implements $HistoryClientsCopyWith<$Res> {
  factory _$HistoryClientsCopyWith(_HistoryClients value, $Res Function(_HistoryClients) _then) = __$HistoryClientsCopyWithImpl;
@override @useResult
$Res call({
 Map<String, Client> clients, List<HistoryEntry> history, double took
});
...
/// Create a copy of HistoryClients
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? clients = null,Object? history = null,Object? took = null,}) {
  return _then(_HistoryClients(
clients: null == clients ? _self._clients : clients // ignore: cast_nullable_to_non_nullable
as Map<String, Client>,history: null == history ? _self._history : history // ignore: cast_nullable_to_non_nullable
as List<HistoryEntry>,took: null == took ? _self.took : took // ignore: cast_nullable_to_non_nullable
as double,
  ));
}
...
/// Create a copy of Client
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = freezed,Object? total = null,}) {
...
mixin _$HistoryEntry {
 ...
 double get timestamp; Map<String, int> get data;
...
@useResult
$Res call({
 double timestamp, Map<String, int> data
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( double timestamp,  Map<String, int> data)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _HistoryEntry() when $default != null:
return $default(_that.timestamp,_that.data);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( double timestamp,  Map<String, int> data)  $default,) {final _that = this;
switch (_that) {
case _HistoryEntry():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( double timestamp,  Map<String, int> data)?  $default,) {final _that = this;
switch (_that) {
case _HistoryEntry() when $default != null:
return $default(_that.timestamp,_that.data);case _:
  return null;
...
@override Map<String, int> get data {
...
/// Create a copy of HistoryEntry
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? timestamp = null,Object? data = null,}) {
