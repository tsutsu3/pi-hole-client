...
mixin _$AuthSessions {
 ...
 List<SessionData> get sessions; double get took;
/// Create a copy of AuthSessions
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$AuthSessionsCopyWith<AuthSessions> get copyWith => _$AuthSessionsCopyWithImpl<AuthSessions>(this as AuthSessions, _$identity);
...
abstract mixin class $AuthSessionsCopyWith<$Res>  {
  factory $AuthSessionsCopyWith(AuthSessions value, $Res Function(AuthSessions) _then) = _$AuthSessionsCopyWithImpl;
@useResult
$Res call({
 List<SessionData> sessions, double took
});
...
/// @nodoc
class _$AuthSessionsCopyWithImpl<$Res>
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _AuthSessions value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _AuthSessions value)  $default,){
final _that = this;
switch (_that) {
case _AuthSessions():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _AuthSessions value)?  $default,){
final _that = this;
switch (_that) {
case _AuthSessions() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<SessionData> sessions,  double took)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthSessions() when $default != null:
return $default(_that.sessions,_that.took);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<SessionData> sessions,  double took)  $default,) {final _that = this;
switch (_that) {
case _AuthSessions():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<SessionData> sessions,  double took)?  $default,) {final _that = this;
switch (_that) {
case _AuthSessions() when $default != null:
return $default(_that.sessions,_that.took);case _:
  return null;
...
@pragma('vm:prefer-inline')
_$AuthSessionsCopyWith<_AuthSessions> get copyWith => __$AuthSessionsCopyWithImpl<_AuthSessions>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$AuthSessionsToJson(this, );
}
...
/// @nodoc
abstract mixin class _$AuthSessionsCopyWith<$Res> implements $AuthSessionsCopyWith<$Res> {
  factory _$AuthSessionsCopyWith(_AuthSessions value, $Res Function(_AuthSessions) _then) = __$AuthSessionsCopyWithImpl;
@override @useResult
$Res call({
 List<SessionData> sessions, double took
});
...
/// Create a copy of AuthSessions
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? sessions = null,Object? took = null,}) {
...
mixin _$SessionData {
 ...
 int get id;@JsonKey(name: 'current_session') bool get currentSession; bool get valid; Tls get tls; bool get app; bool get cli;@JsonKey(name: 'login_at') int get loginAt;@JsonKey(name: 'last_active') int get lastActive;@JsonKey(name: 'valid_until') int get validUntil;@JsonKey(name: 'remote_addr') String get remoteAddr;@JsonKey(name: 'user_agent') String? get userAgent;@JsonKey(name: 'x_forwarded_for') String? get xForwardedFor;
...
@useResult
$Res call({
 int id,@JsonKey(name: 'current_session') bool currentSession, bool valid, Tls tls, bool app, bool cli,@JsonKey(name: 'login_at') int loginAt,@JsonKey(name: 'last_active') int lastActive,@JsonKey(name: 'valid_until') int validUntil,@JsonKey(name: 'remote_addr') String remoteAddr,@JsonKey(name: 'user_agent') String? userAgent,@JsonKey(name: 'x_forwarded_for') String? xForwardedFor
});
...
as Tls,app: null == app ? _self.app : app // ignore: cast_nullable_to_non_nullable
as bool,cli: null == cli ? _self.cli : cli // ignore: cast_nullable_to_non_nullable
as bool,loginAt: null == loginAt ? _self.loginAt : loginAt // ignore: cast_nullable_to_non_nullable
...
as int,remoteAddr: null == remoteAddr ? _self.remoteAddr : remoteAddr // ignore: cast_nullable_to_non_nullable
as String,userAgent: freezed == userAgent ? _self.userAgent : userAgent // ignore: cast_nullable_to_non_nullable
as String?,xForwardedFor: freezed == xForwardedFor ? _self.xForwardedFor : xForwardedFor // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
/// Create a copy of SessionData
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id, @JsonKey(name: 'current_session')  bool currentSession,  bool valid,  Tls tls,  bool app,  bool cli, @JsonKey(name: 'login_at')  int loginAt, @JsonKey(name: 'last_active')  int lastActive, @JsonKey(name: 'valid_until')  int validUntil, @JsonKey(name: 'remote_addr')  String remoteAddr, @JsonKey(name: 'user_agent')  String? userAgent, @JsonKey(name: 'x_forwarded_for')  String? xForwardedFor)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SessionData() when $default != null:
return $default(_that.id,_that.currentSession,_that.valid,_that.tls,_that.app,_that.cli,_that.loginAt,_that.lastActive,_that.validUntil,_that.remoteAddr,_that.userAgent,_that.xForwardedFor);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id, @JsonKey(name: 'current_session')  bool currentSession,  bool valid,  Tls tls,  bool app,  bool cli, @JsonKey(name: 'login_at')  int loginAt, @JsonKey(name: 'last_active')  int lastActive, @JsonKey(name: 'valid_until')  int validUntil, @JsonKey(name: 'remote_addr')  String remoteAddr, @JsonKey(name: 'user_agent')  String? userAgent, @JsonKey(name: 'x_forwarded_for')  String? xForwardedFor)  $default,) {final _that = this;
switch (_that) {
case _SessionData():
return $default(_that.id,_that.currentSession,_that.valid,_that.tls,_that.app,_that.cli,_that.loginAt,_that.lastActive,_that.validUntil,_that.remoteAddr,_that.userAgent,_that.xForwardedFor);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id, @JsonKey(name: 'current_session')  bool currentSession,  bool valid,  Tls tls,  bool app,  bool cli, @JsonKey(name: 'login_at')  int loginAt, @JsonKey(name: 'last_active')  int lastActive, @JsonKey(name: 'valid_until')  int validUntil, @JsonKey(name: 'remote_addr')  String remoteAddr, @JsonKey(name: 'user_agent')  String? userAgent, @JsonKey(name: 'x_forwarded_for')  String? xForwardedFor)?  $default,) {final _that = this;
switch (_that) {
case _SessionData() when $default != null:
return $default(_that.id,_that.currentSession,_that.valid,_that.tls,_that.app,_that.cli,_that.loginAt,_that.lastActive,_that.validUntil,_that.remoteAddr,_that.userAgent,_that.xForwardedFor);case _:
  return null;
...
class _SessionData implements SessionData {
  const _SessionData({required this.id, @JsonKey(name: 'current_session') required this.currentSession, required this.valid, required this.tls, required this.app, required this.cli, @JsonKey(name: 'login_at') required this.loginAt, @JsonKey(name: 'last_active') required this.lastActive, @JsonKey(name: 'valid_until') required this.validUntil, @JsonKey(name: 'remote_addr') required this.remoteAddr, @JsonKey(name: 'user_agent') this.userAgent, @JsonKey(name: 'x_forwarded_for') this.xForwardedFor});
  factory _SessionData.fromJson(Map<String, dynamic> json) => _$SessionDataFromJson(json);

@override final  int id;
@override@JsonKey(name: 'current_session') final  bool currentSession;
@override final  bool valid;
@override final  Tls tls;
@override final  bool app;
@override final  bool cli;
@override@JsonKey(name: 'login_at') final  int loginAt;
@override@JsonKey(name: 'last_active') final  int lastActive;
...
@override@JsonKey(name: 'x_forwarded_for') final  String? xForwardedFor;
...
@override $TlsCopyWith<$Res> get tls;
...
/// Create a copy of SessionData
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? currentSession = null,Object? valid = null,Object? tls = null,Object? app = null,Object? cli = null,Object? loginAt = null,Object? lastActive = null,Object? validUntil = null,Object? remoteAddr = null,Object? userAgent = freezed,Object? xForwardedFor = freezed,}) {
...
mixin _$Tls {
 ...
 bool get login; bool get mixed;
/// Create a copy of Tls
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$TlsCopyWith<Tls> get copyWith => _$TlsCopyWithImpl<Tls>(this as Tls, _$identity);
...
/// @nodoc
class _$TlsCopyWithImpl<$Res>
    implements $TlsCopyWith<$Res> {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _Tls value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _Tls value)  $default,){
final _that = this;
switch (_that) {
case _Tls():
return $default(_that);}
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _Tls value)?  $default,){
final _that = this;
switch (_that) {
case _Tls() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool login,  bool mixed)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Tls() when $default != null:
return $default(_that.login,_that.mixed);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool login,  bool mixed)  $default,) {final _that = this;
switch (_that) {
case _Tls():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool login,  bool mixed)?  $default,) {final _that = this;
switch (_that) {
case _Tls() when $default != null:
return $default(_that.login,_that.mixed);case _:
  return null;
...
@override final  bool login;
@override final  bool mixed;

/// Create a copy of Tls
/// with the given fields replaced by the non-null parameter values.
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$TlsCopyWith<_Tls> get copyWith => __$TlsCopyWithImpl<_Tls>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$TlsToJson(this, );
}
...
abstract mixin class _$TlsCopyWith<$Res> implements $TlsCopyWith<$Res> {
  factory _$TlsCopyWith(_Tls value, $Res Function(_Tls) _then) = __$TlsCopyWithImpl;
@override @useResult
$Res call({
 bool login, bool mixed
});
...
/// @nodoc
class __$TlsCopyWithImpl<$Res>
    implements _$TlsCopyWith<$Res> {
...
/// Create a copy of Tls
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? login = null,Object? mixed = null,}) {
  return _then(_Tls(
login: null == login ? _self.login : login // ignore: cast_nullable_to_non_nullable
as bool,mixed: null == mixed ? _self.mixed : mixed // ignore: cast_nullable_to_non_nullable
as bool,
