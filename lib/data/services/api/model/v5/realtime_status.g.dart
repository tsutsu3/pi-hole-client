...
_RealTimeStatus _$RealTimeStatusFromJson(Map<String, dynamic> json) =>
    _RealTimeStatus(
      ...
      topSourcesBlocked:
          const MapOrEmptyListConverter().fromJson(json['top_sources_blocked']),
      forwardDestinations:
          (json['forward_destinations'] as Map<String, dynamic>).map(
        (k, e) => MapEntry(k, (e as num).toDouble()),
      ),
      queryTypes:
          QueryTypes.fromJson(json['querytypes'] as Map<String, dynamic>),
    );
...
Map<String, dynamic> _$RealTimeStatusToJson(_RealTimeStatus instance) =>
    <String, dynamic>{
      ...
      'top_queries':
          const MapOrEmptyListConverter().toJson(instance.topQueries),
      'top_ads': const MapOrEmptyListConverter().toJson(instance.topAds),
      'top_sources':
          const MapOrEmptyListConverter().toJson(instance.topSources),
      'top_sources_blocked':
          const MapOrEmptyListConverter().toJson(instance.topSourcesBlocked),
