...
@JsonKey(name: 'domains_being_blocked') int get domainsBeingBlocked;@JsonKey(name: 'dns_queries_today') int get dnsQueriesToday;@JsonKey(name: 'ads_blocked_today') int get adsBlockedToday;@JsonKey(name: 'ads_percentage_today') double get adsPercentageToday;@JsonKey(name: 'unique_domains') int get uniqueDomains;@JsonKey(name: 'queries_forwarded') int get queriesForwarded;@JsonKey(name: 'queries_cached') int get queriesCached;@JsonKey(name: 'clients_ever_seen') int get clientsEverSeen;@JsonKey(name: 'unique_clients') int get uniqueClients;@JsonKey(name: 'dns_queries_all_types') int get dnsQueriesAllTypes;@JsonKey(name: 'reply_UNKNOWN') int get replyUnknown;@JsonKey(name: 'reply_NODATA') int get replyNodata;@JsonKey(name: 'reply_NXDOMAIN') int get replyNxDomain;@JsonKey(name: 'reply_CNAME') int get replyCname;@JsonKey(name: 'reply_IP') int get replyIp;@JsonKey(name: 'reply_DOMAIN') int get replyDomain;@JsonKey(name: 'reply_RRNAME') int get replyRrname;@JsonKey(name: 'reply_SERVFAIL') int get replyServfail;@JsonKey(name: 'reply_REFUSED') int get replyRefused;@JsonKey(name: 'reply_NOTIMP') int get replyNotimp;@JsonKey(name: 'reply_OTHER') int get replyOther;@JsonKey(name: 'reply_DNSSEC') int get replyDnssec;@JsonKey(name: 'reply_NONE') int get replyNone;@JsonKey(name: 'reply_BLOB') int get replyBlob;@JsonKey(name: 'dns_queries_all_replies') int get dnsQueriesAllReplies;@JsonKey(name: 'privacy_level') int get privacyLevel; String get status;@JsonKey(name: 'gravity_last_updated') GravityLastUpdated get gravityLastUpdated;@JsonKey(name: 'top_queries')@MapOrEmptyListConverter() Map<String, int> get topQueries;@JsonKey(name: 'top_ads')@MapOrEmptyListConverter() Map<String, int> get topAds;@JsonKey(name: 'top_sources')@MapOrEmptyListConverter() Map<String, int> get topSources;@JsonKey(name: 'top_sources_blocked')@MapOrEmptyListConverter() Map<String, int> get topSourcesBlocked;@JsonKey(name: 'forward_destinations')@MapOrEmptyListConverter() Map<String, double> get forwardDestinations;@JsonKey(name: 'querytypes') QueryTypes get queryTypes;
...
@useResult
$Res call({
@JsonKey(name: 'domains_being_blocked') int domainsBeingBlocked,@JsonKey(name: 'dns_queries_today') int dnsQueriesToday,@JsonKey(name: 'ads_blocked_today') int adsBlockedToday,@JsonKey(name: 'ads_percentage_today') double adsPercentageToday,@JsonKey(name: 'unique_domains') int uniqueDomains,@JsonKey(name: 'queries_forwarded') int queriesForwarded,@JsonKey(name: 'queries_cached') int queriesCached,@JsonKey(name: 'clients_ever_seen') int clientsEverSeen,@JsonKey(name: 'unique_clients') int uniqueClients,@JsonKey(name: 'dns_queries_all_types') int dnsQueriesAllTypes,@JsonKey(name: 'reply_UNKNOWN') int replyUnknown,@JsonKey(name: 'reply_NODATA') int replyNodata,@JsonKey(name: 'reply_NXDOMAIN') int replyNxDomain,@JsonKey(name: 'reply_CNAME') int replyCname,@JsonKey(name: 'reply_IP') int replyIp,@JsonKey(name: 'reply_DOMAIN') int replyDomain,@JsonKey(name: 'reply_RRNAME') int replyRrname,@JsonKey(name: 'reply_SERVFAIL') int replyServfail,@JsonKey(name: 'reply_REFUSED') int replyRefused,@JsonKey(name: 'reply_NOTIMP') int replyNotimp,@JsonKey(name: 'reply_OTHER') int replyOther,@JsonKey(name: 'reply_DNSSEC') int replyDnssec,@JsonKey(name: 'reply_NONE') int replyNone,@JsonKey(name: 'reply_BLOB') int replyBlob,@JsonKey(name: 'dns_queries_all_replies') int dnsQueriesAllReplies,@JsonKey(name: 'privacy_level') int privacyLevel, String status,@JsonKey(name: 'gravity_last_updated') GravityLastUpdated gravityLastUpdated,@JsonKey(name: 'top_queries')@MapOrEmptyListConverter() Map<String, int> topQueries,@JsonKey(name: 'top_ads')@MapOrEmptyListConverter() Map<String, int> topAds,@JsonKey(name: 'top_sources')@MapOrEmptyListConverter() Map<String, int> topSources,@JsonKey(name: 'top_sources_blocked')@MapOrEmptyListConverter() Map<String, int> topSourcesBlocked,@JsonKey(name: 'forward_destinations')@MapOrEmptyListConverter() Map<String, double> forwardDestinations,@JsonKey(name: 'querytypes') QueryTypes queryTypes
});


$GravityLastUpdatedCopyWith<$Res> get gravityLastUpdated;$QueryTypesCopyWith<$Res> get queryTypes;
...
as String,gravityLastUpdated: null == gravityLastUpdated ? _self.gravityLastUpdated : gravityLastUpdated // ignore: cast_nullable_to_non_nullable
as GravityLastUpdated,topQueries: null == topQueries ? _self.topQueries : topQueries // ignore: cast_nullable_to_non_nullable
as Map<String, int>,topAds: null == topAds ? _self.topAds : topAds // ignore: cast_nullable_to_non_nullable
as Map<String, int>,topSources: null == topSources ? _self.topSources : topSources // ignore: cast_nullable_to_non_nullable
as Map<String, int>,topSourcesBlocked: null == topSourcesBlocked ? _self.topSourcesBlocked : topSourcesBlocked // ignore: cast_nullable_to_non_nullable
as Map<String, int>,forwardDestinations: null == forwardDestinations ? _self.forwardDestinations : forwardDestinations // ignore: cast_nullable_to_non_nullable
as Map<String, double>,queryTypes: null == queryTypes ? _self.queryTypes : queryTypes // ignore: cast_nullable_to_non_nullable
as QueryTypes,
  ));
}
/// Create a copy of RealTimeStatus
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'domains_being_blocked')  int domainsBeingBlocked, @JsonKey(name: 'dns_queries_today')  int dnsQueriesToday, @JsonKey(name: 'ads_blocked_today')  int adsBlockedToday, @JsonKey(name: 'ads_percentage_today')  double adsPercentageToday, @JsonKey(name: 'unique_domains')  int uniqueDomains, @JsonKey(name: 'queries_forwarded')  int queriesForwarded, @JsonKey(name: 'queries_cached')  int queriesCached, @JsonKey(name: 'clients_ever_seen')  int clientsEverSeen, @JsonKey(name: 'unique_clients')  int uniqueClients, @JsonKey(name: 'dns_queries_all_types')  int dnsQueriesAllTypes, @JsonKey(name: 'reply_UNKNOWN')  int replyUnknown, @JsonKey(name: 'reply_NODATA')  int replyNodata, @JsonKey(name: 'reply_NXDOMAIN')  int replyNxDomain, @JsonKey(name: 'reply_CNAME')  int replyCname, @JsonKey(name: 'reply_IP')  int replyIp, @JsonKey(name: 'reply_DOMAIN')  int replyDomain, @JsonKey(name: 'reply_RRNAME')  int replyRrname, @JsonKey(name: 'reply_SERVFAIL')  int replyServfail, @JsonKey(name: 'reply_REFUSED')  int replyRefused, @JsonKey(name: 'reply_NOTIMP')  int replyNotimp, @JsonKey(name: 'reply_OTHER')  int replyOther, @JsonKey(name: 'reply_DNSSEC')  int replyDnssec, @JsonKey(name: 'reply_NONE')  int replyNone, @JsonKey(name: 'reply_BLOB')  int replyBlob, @JsonKey(name: 'dns_queries_all_replies')  int dnsQueriesAllReplies, @JsonKey(name: 'privacy_level')  int privacyLevel,  String status, @JsonKey(name: 'gravity_last_updated')  GravityLastUpdated gravityLastUpdated, @JsonKey(name: 'top_queries')@MapOrEmptyListConverter()  Map<String, int> topQueries, @JsonKey(name: 'top_ads')@MapOrEmptyListConverter()  Map<String, int> topAds, @JsonKey(name: 'top_sources')@MapOrEmptyListConverter()  Map<String, int> topSources, @JsonKey(name: 'top_sources_blocked')@MapOrEmptyListConverter()  Map<String, int> topSourcesBlocked, @JsonKey(name: 'forward_destinations')@MapOrEmptyListConverter()  Map<String, double> forwardDestinations, @JsonKey(name: 'querytypes')  QueryTypes queryTypes)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RealTimeStatus() when $default != null:
return $default(_that.domainsBeingBlocked,_that.dnsQueriesToday,_that.adsBlockedToday,_that.adsPercentageToday,_that.uniqueDomains,_that.queriesForwarded,_that.queriesCached,_that.clientsEverSeen,_that.uniqueClients,_that.dnsQueriesAllTypes,_that.replyUnknown,_that.replyNodata,_that.replyNxDomain,_that.replyCname,_that.replyIp,_that.replyDomain,_that.replyRrname,_that.replyServfail,_that.replyRefused,_that.replyNotimp,_that.replyOther,_that.replyDnssec,_that.replyNone,_that.replyBlob,_that.dnsQueriesAllReplies,_that.privacyLevel,_that.status,_that.gravityLastUpdated,_that.topQueries,_that.topAds,_that.topSources,_that.topSourcesBlocked,_that.forwardDestinations,_that.queryTypes);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'domains_being_blocked')  int domainsBeingBlocked, @JsonKey(name: 'dns_queries_today')  int dnsQueriesToday, @JsonKey(name: 'ads_blocked_today')  int adsBlockedToday, @JsonKey(name: 'ads_percentage_today')  double adsPercentageToday, @JsonKey(name: 'unique_domains')  int uniqueDomains, @JsonKey(name: 'queries_forwarded')  int queriesForwarded, @JsonKey(name: 'queries_cached')  int queriesCached, @JsonKey(name: 'clients_ever_seen')  int clientsEverSeen, @JsonKey(name: 'unique_clients')  int uniqueClients, @JsonKey(name: 'dns_queries_all_types')  int dnsQueriesAllTypes, @JsonKey(name: 'reply_UNKNOWN')  int replyUnknown, @JsonKey(name: 'reply_NODATA')  int replyNodata, @JsonKey(name: 'reply_NXDOMAIN')  int replyNxDomain, @JsonKey(name: 'reply_CNAME')  int replyCname, @JsonKey(name: 'reply_IP')  int replyIp, @JsonKey(name: 'reply_DOMAIN')  int replyDomain, @JsonKey(name: 'reply_RRNAME')  int replyRrname, @JsonKey(name: 'reply_SERVFAIL')  int replyServfail, @JsonKey(name: 'reply_REFUSED')  int replyRefused, @JsonKey(name: 'reply_NOTIMP')  int replyNotimp, @JsonKey(name: 'reply_OTHER')  int replyOther, @JsonKey(name: 'reply_DNSSEC')  int replyDnssec, @JsonKey(name: 'reply_NONE')  int replyNone, @JsonKey(name: 'reply_BLOB')  int replyBlob, @JsonKey(name: 'dns_queries_all_replies')  int dnsQueriesAllReplies, @JsonKey(name: 'privacy_level')  int privacyLevel,  String status, @JsonKey(name: 'gravity_last_updated')  GravityLastUpdated gravityLastUpdated, @JsonKey(name: 'top_queries')@MapOrEmptyListConverter()  Map<String, int> topQueries, @JsonKey(name: 'top_ads')@MapOrEmptyListConverter()  Map<String, int> topAds, @JsonKey(name: 'top_sources')@MapOrEmptyListConverter()  Map<String, int> topSources, @JsonKey(name: 'top_sources_blocked')@MapOrEmptyListConverter()  Map<String, int> topSourcesBlocked, @JsonKey(name: 'forward_destinations')@MapOrEmptyListConverter()  Map<String, double> forwardDestinations, @JsonKey(name: 'querytypes')  QueryTypes queryTypes)  $default,) {final _that = this;
switch (_that) {
case _RealTimeStatus():
return $default(_that.domainsBeingBlocked,_that.dnsQueriesToday,_that.adsBlockedToday,_that.adsPercentageToday,_that.uniqueDomains,_that.queriesForwarded,_that.queriesCached,_that.clientsEverSeen,_that.uniqueClients,_that.dnsQueriesAllTypes,_that.replyUnknown,_that.replyNodata,_that.replyNxDomain,_that.replyCname,_that.replyIp,_that.replyDomain,_that.replyRrname,_that.replyServfail,_that.replyRefused,_that.replyNotimp,_that.replyOther,_that.replyDnssec,_that.replyNone,_that.replyBlob,_that.dnsQueriesAllReplies,_that.privacyLevel,_that.status,_that.gravityLastUpdated,_that.topQueries,_that.topAds,_that.topSources,_that.topSourcesBlocked,_that.forwardDestinations,_that.queryTypes);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'domains_being_blocked')  int domainsBeingBlocked, @JsonKey(name: 'dns_queries_today')  int dnsQueriesToday, @JsonKey(name: 'ads_blocked_today')  int adsBlockedToday, @JsonKey(name: 'ads_percentage_today')  double adsPercentageToday, @JsonKey(name: 'unique_domains')  int uniqueDomains, @JsonKey(name: 'queries_forwarded')  int queriesForwarded, @JsonKey(name: 'queries_cached')  int queriesCached, @JsonKey(name: 'clients_ever_seen')  int clientsEverSeen, @JsonKey(name: 'unique_clients')  int uniqueClients, @JsonKey(name: 'dns_queries_all_types')  int dnsQueriesAllTypes, @JsonKey(name: 'reply_UNKNOWN')  int replyUnknown, @JsonKey(name: 'reply_NODATA')  int replyNodata, @JsonKey(name: 'reply_NXDOMAIN')  int replyNxDomain, @JsonKey(name: 'reply_CNAME')  int replyCname, @JsonKey(name: 'reply_IP')  int replyIp, @JsonKey(name: 'reply_DOMAIN')  int replyDomain, @JsonKey(name: 'reply_RRNAME')  int replyRrname, @JsonKey(name: 'reply_SERVFAIL')  int replyServfail, @JsonKey(name: 'reply_REFUSED')  int replyRefused, @JsonKey(name: 'reply_NOTIMP')  int replyNotimp, @JsonKey(name: 'reply_OTHER')  int replyOther, @JsonKey(name: 'reply_DNSSEC')  int replyDnssec, @JsonKey(name: 'reply_NONE')  int replyNone, @JsonKey(name: 'reply_BLOB')  int replyBlob, @JsonKey(name: 'dns_queries_all_replies')  int dnsQueriesAllReplies, @JsonKey(name: 'privacy_level')  int privacyLevel,  String status, @JsonKey(name: 'gravity_last_updated')  GravityLastUpdated gravityLastUpdated, @JsonKey(name: 'top_queries')@MapOrEmptyListConverter()  Map<String, int> topQueries, @JsonKey(name: 'top_ads')@MapOrEmptyListConverter()  Map<String, int> topAds, @JsonKey(name: 'top_sources')@MapOrEmptyListConverter()  Map<String, int> topSources, @JsonKey(name: 'top_sources_blocked')@MapOrEmptyListConverter()  Map<String, int> topSourcesBlocked, @JsonKey(name: 'forward_destinations')@MapOrEmptyListConverter()  Map<String, double> forwardDestinations, @JsonKey(name: 'querytypes')  QueryTypes queryTypes)?  $default,) {final _that = this;
switch (_that) {
case _RealTimeStatus() when $default != null:
return $default(_that.domainsBeingBlocked,_that.dnsQueriesToday,_that.adsBlockedToday,_that.adsPercentageToday,_that.uniqueDomains,_that.queriesForwarded,_that.queriesCached,_that.clientsEverSeen,_that.uniqueClients,_that.dnsQueriesAllTypes,_that.replyUnknown,_that.replyNodata,_that.replyNxDomain,_that.replyCname,_that.replyIp,_that.replyDomain,_that.replyRrname,_that.replyServfail,_that.replyRefused,_that.replyNotimp,_that.replyOther,_that.replyDnssec,_that.replyNone,_that.replyBlob,_that.dnsQueriesAllReplies,_that.privacyLevel,_that.status,_that.gravityLastUpdated,_that.topQueries,_that.topAds,_that.topSources,_that.topSourcesBlocked,_that.forwardDestinations,_that.queryTypes);case _:
  return null;
...
@override@JsonKey(name: 'dns_queries_today') final  int dnsQueriesToday;
@override@JsonKey(name: 'ads_blocked_today') final  int adsBlockedToday;
@override@JsonKey(name: 'ads_percentage_today') final  double adsPercentageToday;
@override@JsonKey(name: 'unique_domains') final  int uniqueDomains;
@override@JsonKey(name: 'queries_forwarded') final  int queriesForwarded;
@override@JsonKey(name: 'queries_cached') final  int queriesCached;
@override@JsonKey(name: 'clients_ever_seen') final  int clientsEverSeen;
@override@JsonKey(name: 'unique_clients') final  int uniqueClients;
@override@JsonKey(name: 'dns_queries_all_types') final  int dnsQueriesAllTypes;
@override@JsonKey(name: 'reply_UNKNOWN') final  int replyUnknown;
@override@JsonKey(name: 'reply_NODATA') final  int replyNodata;
@override@JsonKey(name: 'reply_NXDOMAIN') final  int replyNxDomain;
@override@JsonKey(name: 'reply_CNAME') final  int replyCname;
@override@JsonKey(name: 'reply_IP') final  int replyIp;
@override@JsonKey(name: 'reply_DOMAIN') final  int replyDomain;
@override@JsonKey(name: 'reply_RRNAME') final  int replyRrname;
@override@JsonKey(name: 'reply_SERVFAIL') final  int replyServfail;
@override@JsonKey(name: 'reply_REFUSED') final  int replyRefused;
@override@JsonKey(name: 'reply_NOTIMP') final  int replyNotimp;
@override@JsonKey(name: 'reply_OTHER') final  int replyOther;
@override@JsonKey(name: 'reply_DNSSEC') final  int replyDnssec;
@override@JsonKey(name: 'reply_NONE') final  int replyNone;
@override@JsonKey(name: 'reply_BLOB') final  int replyBlob;
@override@JsonKey(name: 'dns_queries_all_replies') final  int dnsQueriesAllReplies;
@override@JsonKey(name: 'privacy_level') final  int privacyLevel;
@override final  String status;
@override@JsonKey(name: 'gravity_last_updated') final  GravityLastUpdated gravityLastUpdated;
 final  Map<String, int> _topQueries;
@override@JsonKey(name: 'top_queries')@MapOrEmptyListConverter() Map<String, int> get topQueries {
...
@override@JsonKey(name: 'top_ads')@MapOrEmptyListConverter() Map<String, int> get topAds {
...
@override@JsonKey(name: 'top_sources')@MapOrEmptyListConverter() Map<String, int> get topSources {
...
@override@JsonKey(name: 'top_sources_blocked')@MapOrEmptyListConverter() Map<String, int> get topSourcesBlocked {
  if (_topSourcesBlocked is EqualUnmodifiableMapView) return _topSourcesBlocked;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableMapView(_topSourcesBlocked);
}

 final  Map<String, double> _forwardDestinations;
@override@JsonKey(name: 'forward_destinations')@MapOrEmptyListConverter() Map<String, double> get forwardDestinations {
  if (_forwardDestinations is EqualUnmodifiableMapView) return _forwardDestinations;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableMapView(_forwardDestinations);
}

@override@JsonKey(name: 'querytypes') final  QueryTypes queryTypes;
...
@override $GravityLastUpdatedCopyWith<$Res> get gravityLastUpdated;@override $QueryTypesCopyWith<$Res> get queryTypes;
...
as int,status: null == status ? _self.status : status // ignore: cast_nullable_to_non_nullable
as String,gravityLastUpdated: null == gravityLastUpdated ? _self.gravityLastUpdated : gravityLastUpdated // ignore: cast_nullable_to_non_nullable
as GravityLastUpdated,topQueries: null == topQueries ? _self._topQueries : topQueries // ignore: cast_nullable_to_non_nullable
as Map<String, int>,topAds: null == topAds ? _self._topAds : topAds // ignore: cast_nullable_to_non_nullable
as Map<String, int>,topSources: null == topSources ? _self._topSources : topSources // ignore: cast_nullable_to_non_nullable
as Map<String, int>,topSourcesBlocked: null == topSourcesBlocked ? _self._topSourcesBlocked : topSourcesBlocked // ignore: cast_nullable_to_non_nullable
as Map<String, int>,forwardDestinations: null == forwardDestinations ? _self._forwardDestinations : forwardDestinations // ignore: cast_nullable_to_non_nullable
as Map<String, double>,queryTypes: null == queryTypes ? _self.queryTypes : queryTypes // ignore: cast_nullable_to_non_nullable
as QueryTypes,
  ));
}
...
@JsonKey(name: 'file_exists') bool get fileExists; int get absolute; GravityRelativeTime get relative;
/// Create a copy of GravityLastUpdated
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$GravityLastUpdatedCopyWith<GravityLastUpdated> get copyWith => _$GravityLastUpdatedCopyWithImpl<GravityLastUpdated>(this as GravityLastUpdated, _$identity);
...
abstract mixin class $GravityLastUpdatedCopyWith<$Res>  {
  factory $GravityLastUpdatedCopyWith(GravityLastUpdated value, $Res Function(GravityLastUpdated) _then) = _$GravityLastUpdatedCopyWithImpl;
@useResult
$Res call({
@JsonKey(name: 'file_exists') bool fileExists, int absolute, GravityRelativeTime relative
});
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _GravityLastUpdated value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _GravityLastUpdated value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _GravityLastUpdated value)?  $default,){
final _that = this;
switch (_that) {
case _GravityLastUpdated() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'file_exists')  bool fileExists,  int absolute,  GravityRelativeTime relative)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GravityLastUpdated() when $default != null:
return $default(_that.fileExists,_that.absolute,_that.relative);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'file_exists')  bool fileExists,  int absolute,  GravityRelativeTime relative)  $default,) {final _that = this;
switch (_that) {
case _GravityLastUpdated():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'file_exists')  bool fileExists,  int absolute,  GravityRelativeTime relative)?  $default,) {final _that = this;
switch (_that) {
case _GravityLastUpdated() when $default != null:
return $default(_that.fileExists,_that.absolute,_that.relative);case _:
  return null;
...
class _GravityLastUpdated implements GravityLastUpdated {
  const _GravityLastUpdated({@JsonKey(name: 'file_exists') required this.fileExists, required this.absolute, required this.relative});
  factory _GravityLastUpdated.fromJson(Map<String, dynamic> json) => _$GravityLastUpdatedFromJson(json);

@override@JsonKey(name: 'file_exists') final  bool fileExists;
@override final  int absolute;
@override final  GravityRelativeTime relative;

/// Create a copy of GravityLastUpdated
/// with the given fields replaced by the non-null parameter values.
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$GravityLastUpdatedCopyWith<_GravityLastUpdated> get copyWith => __$GravityLastUpdatedCopyWithImpl<_GravityLastUpdated>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$GravityLastUpdatedToJson(this, );
}
...
/// @nodoc
abstract mixin class _$GravityLastUpdatedCopyWith<$Res> implements $GravityLastUpdatedCopyWith<$Res> {
  factory _$GravityLastUpdatedCopyWith(_GravityLastUpdated value, $Res Function(_GravityLastUpdated) _then) = __$GravityLastUpdatedCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: 'file_exists') bool fileExists, int absolute, GravityRelativeTime relative
});
...
@override $GravityRelativeTimeCopyWith<$Res> get relative;
...
/// Create a copy of GravityLastUpdated
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? fileExists = null,Object? absolute = null,Object? relative = null,}) {
...
mixin _$GravityRelativeTime {
 ...
 int get days; int get hours; int get minutes;
/// Create a copy of GravityRelativeTime
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$GravityRelativeTimeCopyWith<GravityRelativeTime> get copyWith => _$GravityRelativeTimeCopyWithImpl<GravityRelativeTime>(this as GravityRelativeTime, _$identity);
...
abstract mixin class $GravityRelativeTimeCopyWith<$Res>  {
  factory $GravityRelativeTimeCopyWith(GravityRelativeTime value, $Res Function(GravityRelativeTime) _then) = _$GravityRelativeTimeCopyWithImpl;
@useResult
$Res call({
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _GravityRelativeTime value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _GravityRelativeTime value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _GravityRelativeTime value)?  $default,){
final _that = this;
switch (_that) {
case _GravityRelativeTime() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int days,  int hours,  int minutes)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GravityRelativeTime() when $default != null:
return $default(_that.days,_that.hours,_that.minutes);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int days,  int hours,  int minutes)  $default,) {final _that = this;
switch (_that) {
case _GravityRelativeTime():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int days,  int hours,  int minutes)?  $default,) {final _that = this;
switch (_that) {
case _GravityRelativeTime() when $default != null:
return $default(_that.days,_that.hours,_that.minutes);case _:
  return null;
...
class _GravityRelativeTime implements GravityRelativeTime {
  const _GravityRelativeTime({required this.days, required this.hours, required this.minutes});
  factory _GravityRelativeTime.fromJson(Map<String, dynamic> json) => _$GravityRelativeTimeFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$GravityRelativeTimeCopyWith<_GravityRelativeTime> get copyWith => __$GravityRelativeTimeCopyWithImpl<_GravityRelativeTime>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$GravityRelativeTimeToJson(this, );
}
...
/// @nodoc
abstract mixin class _$GravityRelativeTimeCopyWith<$Res> implements $GravityRelativeTimeCopyWith<$Res> {
  factory _$GravityRelativeTimeCopyWith(_GravityRelativeTime value, $Res Function(_GravityRelativeTime) _then) = __$GravityRelativeTimeCopyWithImpl;
@override @useResult
$Res call({
 int days, int hours, int minutes
});
...
/// Create a copy of GravityRelativeTime
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? days = null,Object? hours = null,Object? minutes = null,}) {
...
@JsonKey(name: 'A (IPv4)') double get a;@JsonKey(name: 'AAAA (IPv6)') double get aaaa;@JsonKey(name: 'ANY') double get any;@JsonKey(name: 'SRV') double get srv;@JsonKey(name: 'SOA') double get soa;@JsonKey(name: 'PTR') double get ptr;@JsonKey(name: 'TXT') double get txt;@JsonKey(name: 'NAPTR') double get naptr;@JsonKey(name: 'MX') double get mx;@JsonKey(name: 'DS') double get ds;@JsonKey(name: 'RRSIG') double get rrsig;@JsonKey(name: 'DNSKEY') double get dnskey;@JsonKey(name: 'NS') double get ns;@JsonKey(name: 'OTHER') double get other;@JsonKey(name: 'SVCB') double get svcb;@JsonKey(name: 'HTTPS') double get https;
/// Create a copy of QueryTypes
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$QueryTypesCopyWith<QueryTypes> get copyWith => _$QueryTypesCopyWithImpl<QueryTypes>(this as QueryTypes, _$identity);
...
abstract mixin class $QueryTypesCopyWith<$Res>  {
  factory $QueryTypesCopyWith(QueryTypes value, $Res Function(QueryTypes) _then) = _$QueryTypesCopyWithImpl;
@useResult
$Res call({
@JsonKey(name: 'A (IPv4)') double a,@JsonKey(name: 'AAAA (IPv6)') double aaaa,@JsonKey(name: 'ANY') double any,@JsonKey(name: 'SRV') double srv,@JsonKey(name: 'SOA') double soa,@JsonKey(name: 'PTR') double ptr,@JsonKey(name: 'TXT') double txt,@JsonKey(name: 'NAPTR') double naptr,@JsonKey(name: 'MX') double mx,@JsonKey(name: 'DS') double ds,@JsonKey(name: 'RRSIG') double rrsig,@JsonKey(name: 'DNSKEY') double dnskey,@JsonKey(name: 'NS') double ns,@JsonKey(name: 'OTHER') double other,@JsonKey(name: 'SVCB') double svcb,@JsonKey(name: 'HTTPS') double https
});
...
/// @nodoc
class _$QueryTypesCopyWithImpl<$Res>
...
as double,srv: null == srv ? _self.srv : srv // ignore: cast_nullable_to_non_nullable
as double,soa: null == soa ? _self.soa : soa // ignore: cast_nullable_to_non_nullable
as double,ptr: null == ptr ? _self.ptr : ptr // ignore: cast_nullable_to_non_nullable
as double,txt: null == txt ? _self.txt : txt // ignore: cast_nullable_to_non_nullable
as double,naptr: null == naptr ? _self.naptr : naptr // ignore: cast_nullable_to_non_nullable
as double,mx: null == mx ? _self.mx : mx // ignore: cast_nullable_to_non_nullable
as double,ds: null == ds ? _self.ds : ds // ignore: cast_nullable_to_non_nullable
as double,rrsig: null == rrsig ? _self.rrsig : rrsig // ignore: cast_nullable_to_non_nullable
as double,dnskey: null == dnskey ? _self.dnskey : dnskey // ignore: cast_nullable_to_non_nullable
as double,ns: null == ns ? _self.ns : ns // ignore: cast_nullable_to_non_nullable
as double,other: null == other ? _self.other : other // ignore: cast_nullable_to_non_nullable
as double,svcb: null == svcb ? _self.svcb : svcb // ignore: cast_nullable_to_non_nullable
as double,https: null == https ? _self.https : https // ignore: cast_nullable_to_non_nullable
as double,
  ));
}
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _QueryTypes value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _QueryTypes value)  $default,){
final _that = this;
switch (_that) {
case _QueryTypes():
return $default(_that);}
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _QueryTypes value)?  $default,){
final _that = this;
switch (_that) {
case _QueryTypes() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'A (IPv4)')  double a, @JsonKey(name: 'AAAA (IPv6)')  double aaaa, @JsonKey(name: 'ANY')  double any, @JsonKey(name: 'SRV')  double srv, @JsonKey(name: 'SOA')  double soa, @JsonKey(name: 'PTR')  double ptr, @JsonKey(name: 'TXT')  double txt, @JsonKey(name: 'NAPTR')  double naptr, @JsonKey(name: 'MX')  double mx, @JsonKey(name: 'DS')  double ds, @JsonKey(name: 'RRSIG')  double rrsig, @JsonKey(name: 'DNSKEY')  double dnskey, @JsonKey(name: 'NS')  double ns, @JsonKey(name: 'OTHER')  double other, @JsonKey(name: 'SVCB')  double svcb, @JsonKey(name: 'HTTPS')  double https)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _QueryTypes() when $default != null:
return $default(_that.a,_that.aaaa,_that.any,_that.srv,_that.soa,_that.ptr,_that.txt,_that.naptr,_that.mx,_that.ds,_that.rrsig,_that.dnskey,_that.ns,_that.other,_that.svcb,_that.https);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'A (IPv4)')  double a, @JsonKey(name: 'AAAA (IPv6)')  double aaaa, @JsonKey(name: 'ANY')  double any, @JsonKey(name: 'SRV')  double srv, @JsonKey(name: 'SOA')  double soa, @JsonKey(name: 'PTR')  double ptr, @JsonKey(name: 'TXT')  double txt, @JsonKey(name: 'NAPTR')  double naptr, @JsonKey(name: 'MX')  double mx, @JsonKey(name: 'DS')  double ds, @JsonKey(name: 'RRSIG')  double rrsig, @JsonKey(name: 'DNSKEY')  double dnskey, @JsonKey(name: 'NS')  double ns, @JsonKey(name: 'OTHER')  double other, @JsonKey(name: 'SVCB')  double svcb, @JsonKey(name: 'HTTPS')  double https)  $default,) {final _that = this;
switch (_that) {
case _QueryTypes():
return $default(_that.a,_that.aaaa,_that.any,_that.srv,_that.soa,_that.ptr,_that.txt,_that.naptr,_that.mx,_that.ds,_that.rrsig,_that.dnskey,_that.ns,_that.other,_that.svcb,_that.https);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'A (IPv4)')  double a, @JsonKey(name: 'AAAA (IPv6)')  double aaaa, @JsonKey(name: 'ANY')  double any, @JsonKey(name: 'SRV')  double srv, @JsonKey(name: 'SOA')  double soa, @JsonKey(name: 'PTR')  double ptr, @JsonKey(name: 'TXT')  double txt, @JsonKey(name: 'NAPTR')  double naptr, @JsonKey(name: 'MX')  double mx, @JsonKey(name: 'DS')  double ds, @JsonKey(name: 'RRSIG')  double rrsig, @JsonKey(name: 'DNSKEY')  double dnskey, @JsonKey(name: 'NS')  double ns, @JsonKey(name: 'OTHER')  double other, @JsonKey(name: 'SVCB')  double svcb, @JsonKey(name: 'HTTPS')  double https)?  $default,) {final _that = this;
switch (_that) {
case _QueryTypes() when $default != null:
return $default(_that.a,_that.aaaa,_that.any,_that.srv,_that.soa,_that.ptr,_that.txt,_that.naptr,_that.mx,_that.ds,_that.rrsig,_that.dnskey,_that.ns,_that.other,_that.svcb,_that.https);case _:
  return null;
...
class _QueryTypes implements QueryTypes {
  const _QueryTypes({@JsonKey(name: 'A (IPv4)') required this.a, @JsonKey(name: 'AAAA (IPv6)') required this.aaaa, @JsonKey(name: 'ANY') required this.any, @JsonKey(name: 'SRV') required this.srv, @JsonKey(name: 'SOA') required this.soa, @JsonKey(name: 'PTR') required this.ptr, @JsonKey(name: 'TXT') required this.txt, @JsonKey(name: 'NAPTR') required this.naptr, @JsonKey(name: 'MX') required this.mx, @JsonKey(name: 'DS') required this.ds, @JsonKey(name: 'RRSIG') required this.rrsig, @JsonKey(name: 'DNSKEY') required this.dnskey, @JsonKey(name: 'NS') required this.ns, @JsonKey(name: 'OTHER') required this.other, @JsonKey(name: 'SVCB') required this.svcb, @JsonKey(name: 'HTTPS') required this.https});
  factory _QueryTypes.fromJson(Map<String, dynamic> json) => _$QueryTypesFromJson(json);

@override@JsonKey(name: 'A (IPv4)') final  double a;
@override@JsonKey(name: 'AAAA (IPv6)') final  double aaaa;
@override@JsonKey(name: 'ANY') final  double any;
@override@JsonKey(name: 'SRV') final  double srv;
@override@JsonKey(name: 'SOA') final  double soa;
@override@JsonKey(name: 'PTR') final  double ptr;
@override@JsonKey(name: 'TXT') final  double txt;
@override@JsonKey(name: 'NAPTR') final  double naptr;
@override@JsonKey(name: 'MX') final  double mx;
@override@JsonKey(name: 'DS') final  double ds;
@override@JsonKey(name: 'RRSIG') final  double rrsig;
@override@JsonKey(name: 'DNSKEY') final  double dnskey;
@override@JsonKey(name: 'NS') final  double ns;
@override@JsonKey(name: 'OTHER') final  double other;
@override@JsonKey(name: 'SVCB') final  double svcb;
@override@JsonKey(name: 'HTTPS') final  double https;

/// Create a copy of QueryTypes
/// with the given fields replaced by the non-null parameter values.
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$QueryTypesCopyWith<_QueryTypes> get copyWith => __$QueryTypesCopyWithImpl<_QueryTypes>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$QueryTypesToJson(this, );
}
...
/// @nodoc
abstract mixin class _$QueryTypesCopyWith<$Res> implements $QueryTypesCopyWith<$Res> {
  factory _$QueryTypesCopyWith(_QueryTypes value, $Res Function(_QueryTypes) _then) = __$QueryTypesCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: 'A (IPv4)') double a,@JsonKey(name: 'AAAA (IPv6)') double aaaa,@JsonKey(name: 'ANY') double any,@JsonKey(name: 'SRV') double srv,@JsonKey(name: 'SOA') double soa,@JsonKey(name: 'PTR') double ptr,@JsonKey(name: 'TXT') double txt,@JsonKey(name: 'NAPTR') double naptr,@JsonKey(name: 'MX') double mx,@JsonKey(name: 'DS') double ds,@JsonKey(name: 'RRSIG') double rrsig,@JsonKey(name: 'DNSKEY') double dnskey,@JsonKey(name: 'NS') double ns,@JsonKey(name: 'OTHER') double other,@JsonKey(name: 'SVCB') double svcb,@JsonKey(name: 'HTTPS') double https
});
...
/// @nodoc
class __$QueryTypesCopyWithImpl<$Res>
    implements _$QueryTypesCopyWith<$Res> {
