...
@ListOfListStringOrEmptyConverter() List<List<String>> get data;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Queries&&const DeepCollectionEquality().equals(other.data, data));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@ListOfListStringOrEmptyConverter()  List<List<String>> data)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Queries() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@ListOfListStringOrEmptyConverter()  List<List<String>> data)  $default,) {final _that = this;
switch (_that) {
case _Queries():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@ListOfListStringOrEmptyConverter()  List<List<String>> data)?  $default,) {final _that = this;
switch (_that) {
case _Queries() when $default != null:
return $default(_that.data);case _:
  return null;
...
class _Queries implements Queries {
  const _Queries({@ListOfListStringOrEmptyConverter() required final  List<List<String>> data}): _data = data;
  factory _Queries.fromJson(Map<String, dynamic> json) => _$QueriesFromJson(json);

 final  List<List<String>> _data;
@override@ListOfListStringOrEmptyConverter() List<List<String>> get data {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Queries&&const DeepCollectionEquality().equals(other._data, _data));
}
