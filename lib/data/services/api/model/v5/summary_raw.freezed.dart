...
abstract mixin class $SummaryRawCopyWith<$Res>  {
  factory $SummaryRawCopyWith(SummaryRaw value, $Res Function(SummaryRaw) _then) = _$SummaryRawCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$SummaryRawCopyWithImpl<$Res>
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _SummaryRaw value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _SummaryRaw value)  $default,){
final _that = this;
switch (_that) {
case _SummaryRaw():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _SummaryRaw value)?  $default,){
final _that = this;
switch (_that) {
case _SummaryRaw() when $default != null:
return $default(_that);case _:
...
switch (_that) {
case _SummaryRaw() when $default != null:
return $default(_that.domainsBeingBlocked,_that.dnsQueriesToday,_that.adsBlockedToday,_that.adsPercentageToday,_that.uniqueDomains,_that.queriesForwarded,_that.queriesCached,_that.clientsEverSeen,_that.uniqueClients,_that.dnsQueriesAllTypes,_that.replyUnknown,_that.replyNodata,_that.replyNxDomain,_that.replyCname,_that.replyIp,_that.replyDomain,_that.replyRrname,_that.replyServfail,_that.replyRefused,_that.replyNotimp,_that.replyOther,_that.replyDnssec,_that.replyNone,_that.replyBlob,_that.dnsQueriesAllReplies,_that.privacyLevel,_that.status,_that.gravityLastUpdated);case _:
  return orElse();
...
switch (_that) {
case _SummaryRaw():
return $default(_that.domainsBeingBlocked,_that.dnsQueriesToday,_that.adsBlockedToday,_that.adsPercentageToday,_that.uniqueDomains,_that.queriesForwarded,_that.queriesCached,_that.clientsEverSeen,_that.uniqueClients,_that.dnsQueriesAllTypes,_that.replyUnknown,_that.replyNodata,_that.replyNxDomain,_that.replyCname,_that.replyIp,_that.replyDomain,_that.replyRrname,_that.replyServfail,_that.replyRefused,_that.replyNotimp,_that.replyOther,_that.replyDnssec,_that.replyNone,_that.replyBlob,_that.dnsQueriesAllReplies,_that.privacyLevel,_that.status,_that.gravityLastUpdated);}
}
...
@pragma('vm:prefer-inline')
_$SummaryRawCopyWith<_SummaryRaw> get copyWith => __$SummaryRawCopyWithImpl<_SummaryRaw>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$SummaryRawToJson(this, );
}
...
/// @nodoc
abstract mixin class _$SummaryRawCopyWith<$Res> implements $SummaryRawCopyWith<$Res> {
  factory _$SummaryRawCopyWith(_SummaryRaw value, $Res Function(_SummaryRaw) _then) = __$SummaryRawCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: 'domains_being_blocked') int domainsBeingBlocked,@JsonKey(name: 'dns_queries_today') int dnsQueriesToday,@JsonKey(name: 'ads_blocked_today') int adsBlockedToday,@JsonKey(name: 'ads_percentage_today') double adsPercentageToday,@JsonKey(name: 'unique_domains') int uniqueDomains,@JsonKey(name: 'queries_forwarded') int queriesForwarded,@JsonKey(name: 'queries_cached') int queriesCached,@JsonKey(name: 'clients_ever_seen') int clientsEverSeen,@JsonKey(name: 'unique_clients') int uniqueClients,@JsonKey(name: 'dns_queries_all_types') int dnsQueriesAllTypes,@JsonKey(name: 'reply_UNKNOWN') int replyUnknown,@JsonKey(name: 'reply_NODATA') int replyNodata,@JsonKey(name: 'reply_NXDOMAIN') int replyNxDomain,@JsonKey(name: 'reply_CNAME') int replyCname,@JsonKey(name: 'reply_IP') int replyIp,@JsonKey(name: 'reply_DOMAIN') int replyDomain,@JsonKey(name: 'reply_RRNAME') int replyRrname,@JsonKey(name: 'reply_SERVFAIL') int replyServfail,@JsonKey(name: 'reply_REFUSED') int replyRefused,@JsonKey(name: 'reply_NOTIMP') int replyNotimp,@JsonKey(name: 'reply_OTHER') int replyOther,@JsonKey(name: 'reply_DNSSEC') int replyDnssec,@JsonKey(name: 'reply_NONE') int replyNone,@JsonKey(name: 'reply_BLOB') int replyBlob,@JsonKey(name: 'dns_queries_all_replies') int dnsQueriesAllReplies,@JsonKey(name: 'privacy_level') int privacyLevel, String status,@JsonKey(name: 'gravity_last_updated') GravityLastUpdated gravityLastUpdated
});
...
@override $GravityLastUpdatedCopyWith<$Res> get gravityLastUpdated;

}
/// @nodoc
class __$SummaryRawCopyWithImpl<$Res>
    implements _$SummaryRawCopyWith<$Res> {
