...
extension GatewayPatterns on Gateway {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(List<GatewayData> gateway, double took,
            List<InterfaceData>? interfaces, List<RouteData>? routes)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Gateway() when $default != null:
        return $default(
            _that.gateway, _that.took, _that.interfaces, _that.routes);
      case _:
        return orElse();
    }
  }
...
extension GatewayDataPatterns on GatewayData {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_GatewayData value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
