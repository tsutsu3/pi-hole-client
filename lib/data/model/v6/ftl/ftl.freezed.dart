...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Ftl ftl,  double took)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _InfoFtl() when $default != null:
return $default(_that.ftl,_that.took);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Ftl ftl,  double took)  $default,) {final _that = this;
switch (_that) {
case _InfoFtl():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( Ftl ftl,  double took)?  $default,) {final _that = this;
switch (_that) {
case _InfoFtl() when $default != null:
return $default(_that.ftl,_that.took);case _:
  return null;
...
@override $FtlCopyWith<$Res> get ftl;
...
/// Create a copy of InfoFtl
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? ftl = null,Object? took = null,}) {
...
mixin _$Ftl {
 ...
 Database get database;@JsonKey(name: 'privacy_level') int get privacyLevel; Clients get clients; int get pid; int get uptime;@JsonKey(name: '%mem') double get memPercentage;@JsonKey(name: '%cpu') double get cpuPercentage;@JsonKey(name: 'allow_destructive') bool get allowDestructive; Dnsmasq get dnsmasq;
...
@useResult
$Res call({
 Database database,@JsonKey(name: 'privacy_level') int privacyLevel, Clients clients, int pid, int uptime,@JsonKey(name: '%mem') double memPercentage,@JsonKey(name: '%cpu') double cpuPercentage,@JsonKey(name: 'allow_destructive') bool allowDestructive, Dnsmasq dnsmasq
});


$DatabaseCopyWith<$Res> get database;$ClientsCopyWith<$Res> get clients;$DnsmasqCopyWith<$Res> get dnsmasq;
...
as Clients,pid: null == pid ? _self.pid : pid // ignore: cast_nullable_to_non_nullable
as int,uptime: null == uptime ? _self.uptime : uptime // ignore: cast_nullable_to_non_nullable
as int,memPercentage: null == memPercentage ? _self.memPercentage : memPercentage // ignore: cast_nullable_to_non_nullable
as double,cpuPercentage: null == cpuPercentage ? _self.cpuPercentage : cpuPercentage // ignore: cast_nullable_to_non_nullable
as double,allowDestructive: null == allowDestructive ? _self.allowDestructive : allowDestructive // ignore: cast_nullable_to_non_nullable
as bool,dnsmasq: null == dnsmasq ? _self.dnsmasq : dnsmasq // ignore: cast_nullable_to_non_nullable
as Dnsmasq,
  ));
}
/// Create a copy of Ftl
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Database database, @JsonKey(name: 'privacy_level')  int privacyLevel,  Clients clients,  int pid,  int uptime, @JsonKey(name: '%mem')  double memPercentage, @JsonKey(name: '%cpu')  double cpuPercentage, @JsonKey(name: 'allow_destructive')  bool allowDestructive,  Dnsmasq dnsmasq)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Ftl() when $default != null:
return $default(_that.database,_that.privacyLevel,_that.clients,_that.pid,_that.uptime,_that.memPercentage,_that.cpuPercentage,_that.allowDestructive,_that.dnsmasq);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Database database, @JsonKey(name: 'privacy_level')  int privacyLevel,  Clients clients,  int pid,  int uptime, @JsonKey(name: '%mem')  double memPercentage, @JsonKey(name: '%cpu')  double cpuPercentage, @JsonKey(name: 'allow_destructive')  bool allowDestructive,  Dnsmasq dnsmasq)  $default,) {final _that = this;
switch (_that) {
case _Ftl():
return $default(_that.database,_that.privacyLevel,_that.clients,_that.pid,_that.uptime,_that.memPercentage,_that.cpuPercentage,_that.allowDestructive,_that.dnsmasq);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( Database database, @JsonKey(name: 'privacy_level')  int privacyLevel,  Clients clients,  int pid,  int uptime, @JsonKey(name: '%mem')  double memPercentage, @JsonKey(name: '%cpu')  double cpuPercentage, @JsonKey(name: 'allow_destructive')  bool allowDestructive,  Dnsmasq dnsmasq)?  $default,) {final _that = this;
switch (_that) {
case _Ftl() when $default != null:
return $default(_that.database,_that.privacyLevel,_that.clients,_that.pid,_that.uptime,_that.memPercentage,_that.cpuPercentage,_that.allowDestructive,_that.dnsmasq);case _:
  return null;
...
class _Ftl implements Ftl {
  const _Ftl({required this.database, @JsonKey(name: 'privacy_level') required this.privacyLevel, required this.clients, required this.pid, required this.uptime, @JsonKey(name: '%mem') required this.memPercentage, @JsonKey(name: '%cpu') required this.cpuPercentage, @JsonKey(name: 'allow_destructive') required this.allowDestructive, required this.dnsmasq});
...
@override@JsonKey(name: '%mem') final  double memPercentage;
@override@JsonKey(name: '%cpu') final  double cpuPercentage;
@override@JsonKey(name: 'allow_destructive') final  bool allowDestructive;
@override final  Dnsmasq dnsmasq;
...
@override $DatabaseCopyWith<$Res> get database;@override $ClientsCopyWith<$Res> get clients;@override $DnsmasqCopyWith<$Res> get dnsmasq;
...
/// Create a copy of Ftl
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? database = null,Object? privacyLevel = null,Object? clients = null,Object? pid = null,Object? uptime = null,Object? memPercentage = null,Object? cpuPercentage = null,Object? allowDestructive = null,Object? dnsmasq = null,}) {
  return _then(_Ftl(
database: null == database ? _self.database : database // ignore: cast_nullable_to_non_nullable
as Database,privacyLevel: null == privacyLevel ? _self.privacyLevel : privacyLevel // ignore: cast_nullable_to_non_nullable
as int,clients: null == clients ? _self.clients : clients // ignore: cast_nullable_to_non_nullable
...
@JsonKey(name: 'dns_cache_inserted') int get dnsCacheInserted;@JsonKey(name: 'dns_cache_live_freed') int get dnsCacheLiveFreed;@JsonKey(name: 'dns_queries_forwarded') int get dnsQueriesForwarded;@JsonKey(name: 'dns_auth_answered') int get dnsAuthAnswered;@JsonKey(name: 'dns_local_answered') int get dnsLocalAnswered;@JsonKey(name: 'dns_stale_answered') int get dnsStaleAnswered;@JsonKey(name: 'dns_unanswered') int get dnsUnanswered;@JsonKey(name: 'bootp') int get bootp;@JsonKey(name: 'pxe') int get pxe;@JsonKey(name: 'dhcp_ack') int get dhcpAck;@JsonKey(name: 'dhcp_decline') int get dhcpDecline;@JsonKey(name: 'dhcp_discover') int get dhcpDiscover;@JsonKey(name: 'dhcp_inform') int get dhcpInform;@JsonKey(name: 'dhcp_nak') int get dhcpNak;@JsonKey(name: 'dhcp_offer') int get dhcpOffer;@JsonKey(name: 'dhcp_release') int get dhcpRelease;@JsonKey(name: 'dhcp_request') int get dhcpRequest;@JsonKey(name: 'noanswer') int get noAnswer;@JsonKey(name: 'leases_allocated_4') int get leasesAllocated4;@JsonKey(name: 'leases_pruned_4') int get leasesPruned4;@JsonKey(name: 'leases_allocated_6') int get leasesAllocated6;@JsonKey(name: 'leases_pruned_6') int get leasesPruned6;@JsonKey(name: 'tcp_connections') int get tcpConnections;@JsonKey(name: 'dnssec_max_crypto_use') int get dnssecMaxCryptoUse;@JsonKey(name: 'dnssec_max_sig_fail') int get dnssecMaxSigFail;@JsonKey(name: 'dnssec_max_work') int get dnssecMaxWork;
/// Create a copy of Dnsmasq
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$DnsmasqCopyWith<Dnsmasq> get copyWith => _$DnsmasqCopyWithImpl<Dnsmasq>(this as Dnsmasq, _$identity);
...
/// @nodoc
class _$DnsmasqCopyWithImpl<$Res>
...
as int,dnsAuthAnswered: null == dnsAuthAnswered ? _self.dnsAuthAnswered : dnsAuthAnswered // ignore: cast_nullable_to_non_nullable
as int,dnsLocalAnswered: null == dnsLocalAnswered ? _self.dnsLocalAnswered : dnsLocalAnswered // ignore: cast_nullable_to_non_nullable
as int,dnsStaleAnswered: null == dnsStaleAnswered ? _self.dnsStaleAnswered : dnsStaleAnswered // ignore: cast_nullable_to_non_nullable
as int,dnsUnanswered: null == dnsUnanswered ? _self.dnsUnanswered : dnsUnanswered // ignore: cast_nullable_to_non_nullable
...
as int,dhcpAck: null == dhcpAck ? _self.dhcpAck : dhcpAck // ignore: cast_nullable_to_non_nullable
as int,dhcpDecline: null == dhcpDecline ? _self.dhcpDecline : dhcpDecline // ignore: cast_nullable_to_non_nullable
as int,dhcpDiscover: null == dhcpDiscover ? _self.dhcpDiscover : dhcpDiscover // ignore: cast_nullable_to_non_nullable
as int,dhcpInform: null == dhcpInform ? _self.dhcpInform : dhcpInform // ignore: cast_nullable_to_non_nullable
as int,dhcpNak: null == dhcpNak ? _self.dhcpNak : dhcpNak // ignore: cast_nullable_to_non_nullable
as int,dhcpOffer: null == dhcpOffer ? _self.dhcpOffer : dhcpOffer // ignore: cast_nullable_to_non_nullable
as int,dhcpRelease: null == dhcpRelease ? _self.dhcpRelease : dhcpRelease // ignore: cast_nullable_to_non_nullable
as int,dhcpRequest: null == dhcpRequest ? _self.dhcpRequest : dhcpRequest // ignore: cast_nullable_to_non_nullable
as int,noAnswer: null == noAnswer ? _self.noAnswer : noAnswer // ignore: cast_nullable_to_non_nullable
as int,leasesAllocated4: null == leasesAllocated4 ? _self.leasesAllocated4 : leasesAllocated4 // ignore: cast_nullable_to_non_nullable
as int,leasesPruned4: null == leasesPruned4 ? _self.leasesPruned4 : leasesPruned4 // ignore: cast_nullable_to_non_nullable
as int,leasesAllocated6: null == leasesAllocated6 ? _self.leasesAllocated6 : leasesAllocated6 // ignore: cast_nullable_to_non_nullable
as int,leasesPruned6: null == leasesPruned6 ? _self.leasesPruned6 : leasesPruned6 // ignore: cast_nullable_to_non_nullable
as int,tcpConnections: null == tcpConnections ? _self.tcpConnections : tcpConnections // ignore: cast_nullable_to_non_nullable
as int,dnssecMaxCryptoUse: null == dnssecMaxCryptoUse ? _self.dnssecMaxCryptoUse : dnssecMaxCryptoUse // ignore: cast_nullable_to_non_nullable
as int,dnssecMaxSigFail: null == dnssecMaxSigFail ? _self.dnssecMaxSigFail : dnssecMaxSigFail // ignore: cast_nullable_to_non_nullable
as int,dnssecMaxWork: null == dnssecMaxWork ? _self.dnssecMaxWork : dnssecMaxWork // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _Dnsmasq value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _Dnsmasq value)  $default,){
final _that = this;
switch (_that) {
case _Dnsmasq():
return $default(_that);}
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _Dnsmasq value)?  $default,){
final _that = this;
switch (_that) {
case _Dnsmasq() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'dns_cache_inserted')  int dnsCacheInserted, @JsonKey(name: 'dns_cache_live_freed')  int dnsCacheLiveFreed, @JsonKey(name: 'dns_queries_forwarded')  int dnsQueriesForwarded, @JsonKey(name: 'dns_auth_answered')  int dnsAuthAnswered, @JsonKey(name: 'dns_local_answered')  int dnsLocalAnswered, @JsonKey(name: 'dns_stale_answered')  int dnsStaleAnswered, @JsonKey(name: 'dns_unanswered')  int dnsUnanswered, @JsonKey(name: 'bootp')  int bootp, @JsonKey(name: 'pxe')  int pxe, @JsonKey(name: 'dhcp_ack')  int dhcpAck, @JsonKey(name: 'dhcp_decline')  int dhcpDecline, @JsonKey(name: 'dhcp_discover')  int dhcpDiscover, @JsonKey(name: 'dhcp_inform')  int dhcpInform, @JsonKey(name: 'dhcp_nak')  int dhcpNak, @JsonKey(name: 'dhcp_offer')  int dhcpOffer, @JsonKey(name: 'dhcp_release')  int dhcpRelease, @JsonKey(name: 'dhcp_request')  int dhcpRequest, @JsonKey(name: 'noanswer')  int noAnswer, @JsonKey(name: 'leases_allocated_4')  int leasesAllocated4, @JsonKey(name: 'leases_pruned_4')  int leasesPruned4, @JsonKey(name: 'leases_allocated_6')  int leasesAllocated6, @JsonKey(name: 'leases_pruned_6')  int leasesPruned6, @JsonKey(name: 'tcp_connections')  int tcpConnections, @JsonKey(name: 'dnssec_max_crypto_use')  int dnssecMaxCryptoUse, @JsonKey(name: 'dnssec_max_sig_fail')  int dnssecMaxSigFail, @JsonKey(name: 'dnssec_max_work')  int dnssecMaxWork)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Dnsmasq() when $default != null:
return $default(_that.dnsCacheInserted,_that.dnsCacheLiveFreed,_that.dnsQueriesForwarded,_that.dnsAuthAnswered,_that.dnsLocalAnswered,_that.dnsStaleAnswered,_that.dnsUnanswered,_that.bootp,_that.pxe,_that.dhcpAck,_that.dhcpDecline,_that.dhcpDiscover,_that.dhcpInform,_that.dhcpNak,_that.dhcpOffer,_that.dhcpRelease,_that.dhcpRequest,_that.noAnswer,_that.leasesAllocated4,_that.leasesPruned4,_that.leasesAllocated6,_that.leasesPruned6,_that.tcpConnections,_that.dnssecMaxCryptoUse,_that.dnssecMaxSigFail,_that.dnssecMaxWork);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'dns_cache_inserted')  int dnsCacheInserted, @JsonKey(name: 'dns_cache_live_freed')  int dnsCacheLiveFreed, @JsonKey(name: 'dns_queries_forwarded')  int dnsQueriesForwarded, @JsonKey(name: 'dns_auth_answered')  int dnsAuthAnswered, @JsonKey(name: 'dns_local_answered')  int dnsLocalAnswered, @JsonKey(name: 'dns_stale_answered')  int dnsStaleAnswered, @JsonKey(name: 'dns_unanswered')  int dnsUnanswered, @JsonKey(name: 'bootp')  int bootp, @JsonKey(name: 'pxe')  int pxe, @JsonKey(name: 'dhcp_ack')  int dhcpAck, @JsonKey(name: 'dhcp_decline')  int dhcpDecline, @JsonKey(name: 'dhcp_discover')  int dhcpDiscover, @JsonKey(name: 'dhcp_inform')  int dhcpInform, @JsonKey(name: 'dhcp_nak')  int dhcpNak, @JsonKey(name: 'dhcp_offer')  int dhcpOffer, @JsonKey(name: 'dhcp_release')  int dhcpRelease, @JsonKey(name: 'dhcp_request')  int dhcpRequest, @JsonKey(name: 'noanswer')  int noAnswer, @JsonKey(name: 'leases_allocated_4')  int leasesAllocated4, @JsonKey(name: 'leases_pruned_4')  int leasesPruned4, @JsonKey(name: 'leases_allocated_6')  int leasesAllocated6, @JsonKey(name: 'leases_pruned_6')  int leasesPruned6, @JsonKey(name: 'tcp_connections')  int tcpConnections, @JsonKey(name: 'dnssec_max_crypto_use')  int dnssecMaxCryptoUse, @JsonKey(name: 'dnssec_max_sig_fail')  int dnssecMaxSigFail, @JsonKey(name: 'dnssec_max_work')  int dnssecMaxWork)  $default,) {final _that = this;
switch (_that) {
case _Dnsmasq():
return $default(_that.dnsCacheInserted,_that.dnsCacheLiveFreed,_that.dnsQueriesForwarded,_that.dnsAuthAnswered,_that.dnsLocalAnswered,_that.dnsStaleAnswered,_that.dnsUnanswered,_that.bootp,_that.pxe,_that.dhcpAck,_that.dhcpDecline,_that.dhcpDiscover,_that.dhcpInform,_that.dhcpNak,_that.dhcpOffer,_that.dhcpRelease,_that.dhcpRequest,_that.noAnswer,_that.leasesAllocated4,_that.leasesPruned4,_that.leasesAllocated6,_that.leasesPruned6,_that.tcpConnections,_that.dnssecMaxCryptoUse,_that.dnssecMaxSigFail,_that.dnssecMaxWork);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'dns_cache_inserted')  int dnsCacheInserted, @JsonKey(name: 'dns_cache_live_freed')  int dnsCacheLiveFreed, @JsonKey(name: 'dns_queries_forwarded')  int dnsQueriesForwarded, @JsonKey(name: 'dns_auth_answered')  int dnsAuthAnswered, @JsonKey(name: 'dns_local_answered')  int dnsLocalAnswered, @JsonKey(name: 'dns_stale_answered')  int dnsStaleAnswered, @JsonKey(name: 'dns_unanswered')  int dnsUnanswered, @JsonKey(name: 'bootp')  int bootp, @JsonKey(name: 'pxe')  int pxe, @JsonKey(name: 'dhcp_ack')  int dhcpAck, @JsonKey(name: 'dhcp_decline')  int dhcpDecline, @JsonKey(name: 'dhcp_discover')  int dhcpDiscover, @JsonKey(name: 'dhcp_inform')  int dhcpInform, @JsonKey(name: 'dhcp_nak')  int dhcpNak, @JsonKey(name: 'dhcp_offer')  int dhcpOffer, @JsonKey(name: 'dhcp_release')  int dhcpRelease, @JsonKey(name: 'dhcp_request')  int dhcpRequest, @JsonKey(name: 'noanswer')  int noAnswer, @JsonKey(name: 'leases_allocated_4')  int leasesAllocated4, @JsonKey(name: 'leases_pruned_4')  int leasesPruned4, @JsonKey(name: 'leases_allocated_6')  int leasesAllocated6, @JsonKey(name: 'leases_pruned_6')  int leasesPruned6, @JsonKey(name: 'tcp_connections')  int tcpConnections, @JsonKey(name: 'dnssec_max_crypto_use')  int dnssecMaxCryptoUse, @JsonKey(name: 'dnssec_max_sig_fail')  int dnssecMaxSigFail, @JsonKey(name: 'dnssec_max_work')  int dnssecMaxWork)?  $default,) {final _that = this;
switch (_that) {
case _Dnsmasq() when $default != null:
return $default(_that.dnsCacheInserted,_that.dnsCacheLiveFreed,_that.dnsQueriesForwarded,_that.dnsAuthAnswered,_that.dnsLocalAnswered,_that.dnsStaleAnswered,_that.dnsUnanswered,_that.bootp,_that.pxe,_that.dhcpAck,_that.dhcpDecline,_that.dhcpDiscover,_that.dhcpInform,_that.dhcpNak,_that.dhcpOffer,_that.dhcpRelease,_that.dhcpRequest,_that.noAnswer,_that.leasesAllocated4,_that.leasesPruned4,_that.leasesAllocated6,_that.leasesPruned6,_that.tcpConnections,_that.dnssecMaxCryptoUse,_that.dnssecMaxSigFail,_that.dnssecMaxWork);case _:
  return null;
...
class _Dnsmasq implements Dnsmasq {
  const _Dnsmasq({@JsonKey(name: 'dns_cache_inserted') required this.dnsCacheInserted, @JsonKey(name: 'dns_cache_live_freed') required this.dnsCacheLiveFreed, @JsonKey(name: 'dns_queries_forwarded') required this.dnsQueriesForwarded, @JsonKey(name: 'dns_auth_answered') required this.dnsAuthAnswered, @JsonKey(name: 'dns_local_answered') required this.dnsLocalAnswered, @JsonKey(name: 'dns_stale_answered') required this.dnsStaleAnswered, @JsonKey(name: 'dns_unanswered') required this.dnsUnanswered, @JsonKey(name: 'bootp') required this.bootp, @JsonKey(name: 'pxe') required this.pxe, @JsonKey(name: 'dhcp_ack') required this.dhcpAck, @JsonKey(name: 'dhcp_decline') required this.dhcpDecline, @JsonKey(name: 'dhcp_discover') required this.dhcpDiscover, @JsonKey(name: 'dhcp_inform') required this.dhcpInform, @JsonKey(name: 'dhcp_nak') required this.dhcpNak, @JsonKey(name: 'dhcp_offer') required this.dhcpOffer, @JsonKey(name: 'dhcp_release') required this.dhcpRelease, @JsonKey(name: 'dhcp_request') required this.dhcpRequest, @JsonKey(name: 'noanswer') required this.noAnswer, @JsonKey(name: 'leases_allocated_4') required this.leasesAllocated4, @JsonKey(name: 'leases_pruned_4') required this.leasesPruned4, @JsonKey(name: 'leases_allocated_6') required this.leasesAllocated6, @JsonKey(name: 'leases_pruned_6') required this.leasesPruned6, @JsonKey(name: 'tcp_connections') required this.tcpConnections, @JsonKey(name: 'dnssec_max_crypto_use') required this.dnssecMaxCryptoUse, @JsonKey(name: 'dnssec_max_sig_fail') required this.dnssecMaxSigFail, @JsonKey(name: 'dnssec_max_work') required this.dnssecMaxWork});
  factory _Dnsmasq.fromJson(Map<String, dynamic> json) => _$DnsmasqFromJson(json);

@override@JsonKey(name: 'dns_cache_inserted') final  int dnsCacheInserted;
@override@JsonKey(name: 'dns_cache_live_freed') final  int dnsCacheLiveFreed;
@override@JsonKey(name: 'dns_queries_forwarded') final  int dnsQueriesForwarded;
@override@JsonKey(name: 'dns_auth_answered') final  int dnsAuthAnswered;
@override@JsonKey(name: 'dns_local_answered') final  int dnsLocalAnswered;
@override@JsonKey(name: 'dns_stale_answered') final  int dnsStaleAnswered;
@override@JsonKey(name: 'dns_unanswered') final  int dnsUnanswered;
@override@JsonKey(name: 'bootp') final  int bootp;
@override@JsonKey(name: 'pxe') final  int pxe;
@override@JsonKey(name: 'dhcp_ack') final  int dhcpAck;
@override@JsonKey(name: 'dhcp_decline') final  int dhcpDecline;
@override@JsonKey(name: 'dhcp_discover') final  int dhcpDiscover;
@override@JsonKey(name: 'dhcp_inform') final  int dhcpInform;
@override@JsonKey(name: 'dhcp_nak') final  int dhcpNak;
@override@JsonKey(name: 'dhcp_offer') final  int dhcpOffer;
@override@JsonKey(name: 'dhcp_release') final  int dhcpRelease;
@override@JsonKey(name: 'dhcp_request') final  int dhcpRequest;
@override@JsonKey(name: 'noanswer') final  int noAnswer;
@override@JsonKey(name: 'leases_allocated_4') final  int leasesAllocated4;
@override@JsonKey(name: 'leases_pruned_4') final  int leasesPruned4;
@override@JsonKey(name: 'leases_allocated_6') final  int leasesAllocated6;
@override@JsonKey(name: 'leases_pruned_6') final  int leasesPruned6;
@override@JsonKey(name: 'tcp_connections') final  int tcpConnections;
@override@JsonKey(name: 'dnssec_max_crypto_use') final  int dnssecMaxCryptoUse;
@override@JsonKey(name: 'dnssec_max_sig_fail') final  int dnssecMaxSigFail;
@override@JsonKey(name: 'dnssec_max_work') final  int dnssecMaxWork;

/// Create a copy of Dnsmasq
/// with the given fields replaced by the non-null parameter values.
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$DnsmasqCopyWith<_Dnsmasq> get copyWith => __$DnsmasqCopyWithImpl<_Dnsmasq>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$DnsmasqToJson(this, );
}
...
abstract mixin class _$DnsmasqCopyWith<$Res> implements $DnsmasqCopyWith<$Res> {
  factory _$DnsmasqCopyWith(_Dnsmasq value, $Res Function(_Dnsmasq) _then) = __$DnsmasqCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: 'dns_cache_inserted') int dnsCacheInserted,@JsonKey(name: 'dns_cache_live_freed') int dnsCacheLiveFreed,@JsonKey(name: 'dns_queries_forwarded') int dnsQueriesForwarded,@JsonKey(name: 'dns_auth_answered') int dnsAuthAnswered,@JsonKey(name: 'dns_local_answered') int dnsLocalAnswered,@JsonKey(name: 'dns_stale_answered') int dnsStaleAnswered,@JsonKey(name: 'dns_unanswered') int dnsUnanswered,@JsonKey(name: 'bootp') int bootp,@JsonKey(name: 'pxe') int pxe,@JsonKey(name: 'dhcp_ack') int dhcpAck,@JsonKey(name: 'dhcp_decline') int dhcpDecline,@JsonKey(name: 'dhcp_discover') int dhcpDiscover,@JsonKey(name: 'dhcp_inform') int dhcpInform,@JsonKey(name: 'dhcp_nak') int dhcpNak,@JsonKey(name: 'dhcp_offer') int dhcpOffer,@JsonKey(name: 'dhcp_release') int dhcpRelease,@JsonKey(name: 'dhcp_request') int dhcpRequest,@JsonKey(name: 'noanswer') int noAnswer,@JsonKey(name: 'leases_allocated_4') int leasesAllocated4,@JsonKey(name: 'leases_pruned_4') int leasesPruned4,@JsonKey(name: 'leases_allocated_6') int leasesAllocated6,@JsonKey(name: 'leases_pruned_6') int leasesPruned6,@JsonKey(name: 'tcp_connections') int tcpConnections,@JsonKey(name: 'dnssec_max_crypto_use') int dnssecMaxCryptoUse,@JsonKey(name: 'dnssec_max_sig_fail') int dnssecMaxSigFail,@JsonKey(name: 'dnssec_max_work') int dnssecMaxWork
});
...
/// @nodoc
class __$DnsmasqCopyWithImpl<$Res>
    implements _$DnsmasqCopyWith<$Res> {
...
/// Create a copy of Dnsmasq
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? dnsCacheInserted = null,Object? dnsCacheLiveFreed = null,Object? dnsQueriesForwarded = null,Object? dnsAuthAnswered = null,Object? dnsLocalAnswered = null,Object? dnsStaleAnswered = null,Object? dnsUnanswered = null,Object? bootp = null,Object? pxe = null,Object? dhcpAck = null,Object? dhcpDecline = null,Object? dhcpDiscover = null,Object? dhcpInform = null,Object? dhcpNak = null,Object? dhcpOffer = null,Object? dhcpRelease = null,Object? dhcpRequest = null,Object? noAnswer = null,Object? leasesAllocated4 = null,Object? leasesPruned4 = null,Object? leasesAllocated6 = null,Object? leasesPruned6 = null,Object? tcpConnections = null,Object? dnssecMaxCryptoUse = null,Object? dnssecMaxSigFail = null,Object? dnssecMaxWork = null,}) {
