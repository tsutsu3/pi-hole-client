...
mixin _$Interfaces {
 ...
 List<InterfaceData> get interfaces; double get took;
...
@useResult
$Res call({
 List<InterfaceData> interfaces, double took
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<InterfaceData> interfaces,  double took)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Interfaces() when $default != null:
return $default(_that.interfaces,_that.took);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<InterfaceData> interfaces,  double took)  $default,) {final _that = this;
switch (_that) {
case _Interfaces():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<InterfaceData> interfaces,  double took)?  $default,) {final _that = this;
switch (_that) {
case _Interfaces() when $default != null:
return $default(_that.interfaces,_that.took);case _:
  return null;
...
@override List<InterfaceData> get interfaces {
...
/// Create a copy of Interfaces
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? interfaces = null,Object? took = null,}) {
  return _then(_Interfaces(
interfaces: null == interfaces ? _self._interfaces : interfaces // ignore: cast_nullable_to_non_nullable
as List<InterfaceData>,took: null == took ? _self.took : took // ignore: cast_nullable_to_non_nullable
as double,
  ));
}
...
mixin _$InterfaceData {
 ...
 String get name; String get type; List<String> get flags; String get state;@JsonKey(name: 'proto_down') bool get protoDown; String get address; String get broadcast; bool get carrier; InterfaceStats get stats; List<InterfaceAddress> get addresses; int? get index; String? get family; int? get speed;@JsonKey(name: 'perm_address') String? get permAddress; String? get ifname; int? get txqlen; int? get linkmode; int? get mtu;@JsonKey(name: 'min_mtu') int? get minMtu;@JsonKey(name: 'max_mtu') int? get maxMtu; int? get group; int? get promiscuity; List<int>? get unknown;@JsonKey(name: 'num_tx_queues') int? get numTxQueues;@JsonKey(name: 'num_rx_queues') int? get numRxQueues;@JsonKey(name: 'gso_max_segs') int? get gsoMaxSegs;@JsonKey(name: 'gso_max_size') int? get gsoMaxSize; int? get map;@JsonKey(name: 'carrier_changes') int? get carrierChanges;@JsonKey(name: 'carrier_up_count') int? get carrierUpCount;@JsonKey(name: 'carrier_down_count') int? get carrierDownCount;@JsonKey(name: 'link_kind') String? get linkKind; String? get qdisc;@JsonKey(name: 'parent_dev_name') String? get parentDevName;@JsonKey(name: 'parent_dev_bus_name') String? get parentDevBusName;
/// Create a copy of InterfaceData
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$InterfaceDataCopyWith<InterfaceData> get copyWith => _$InterfaceDataCopyWithImpl<InterfaceData>(this as InterfaceData, _$identity);
...
abstract mixin class $InterfaceDataCopyWith<$Res>  {
  factory $InterfaceDataCopyWith(InterfaceData value, $Res Function(InterfaceData) _then) = _$InterfaceDataCopyWithImpl;
@useResult
$Res call({
 String name, String type, List<String> flags, String state,@JsonKey(name: 'proto_down') bool protoDown, String address, String broadcast, bool carrier, InterfaceStats stats, List<InterfaceAddress> addresses, int? index, String? family, int? speed,@JsonKey(name: 'perm_address') String? permAddress, String? ifname, int? txqlen, int? linkmode, int? mtu,@JsonKey(name: 'min_mtu') int? minMtu,@JsonKey(name: 'max_mtu') int? maxMtu, int? group, int? promiscuity, List<int>? unknown,@JsonKey(name: 'num_tx_queues') int? numTxQueues,@JsonKey(name: 'num_rx_queues') int? numRxQueues,@JsonKey(name: 'gso_max_segs') int? gsoMaxSegs,@JsonKey(name: 'gso_max_size') int? gsoMaxSize, int? map,@JsonKey(name: 'carrier_changes') int? carrierChanges,@JsonKey(name: 'carrier_up_count') int? carrierUpCount,@JsonKey(name: 'carrier_down_count') int? carrierDownCount,@JsonKey(name: 'link_kind') String? linkKind, String? qdisc,@JsonKey(name: 'parent_dev_name') String? parentDevName,@JsonKey(name: 'parent_dev_bus_name') String? parentDevBusName
});
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _InterfaceData value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _InterfaceData value)  $default,){
final _that = this;
switch (_that) {
case _InterfaceData():
return $default(_that);}
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _InterfaceData value)?  $default,){
final _that = this;
switch (_that) {
case _InterfaceData() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  String type,  List<String> flags,  String state, @JsonKey(name: 'proto_down')  bool protoDown,  String address,  String broadcast,  bool carrier,  InterfaceStats stats,  List<InterfaceAddress> addresses,  int? index,  String? family,  int? speed, @JsonKey(name: 'perm_address')  String? permAddress,  String? ifname,  int? txqlen,  int? linkmode,  int? mtu, @JsonKey(name: 'min_mtu')  int? minMtu, @JsonKey(name: 'max_mtu')  int? maxMtu,  int? group,  int? promiscuity,  List<int>? unknown, @JsonKey(name: 'num_tx_queues')  int? numTxQueues, @JsonKey(name: 'num_rx_queues')  int? numRxQueues, @JsonKey(name: 'gso_max_segs')  int? gsoMaxSegs, @JsonKey(name: 'gso_max_size')  int? gsoMaxSize,  int? map, @JsonKey(name: 'carrier_changes')  int? carrierChanges, @JsonKey(name: 'carrier_up_count')  int? carrierUpCount, @JsonKey(name: 'carrier_down_count')  int? carrierDownCount, @JsonKey(name: 'link_kind')  String? linkKind,  String? qdisc, @JsonKey(name: 'parent_dev_name')  String? parentDevName, @JsonKey(name: 'parent_dev_bus_name')  String? parentDevBusName)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _InterfaceData() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  String type,  List<String> flags,  String state, @JsonKey(name: 'proto_down')  bool protoDown,  String address,  String broadcast,  bool carrier,  InterfaceStats stats,  List<InterfaceAddress> addresses,  int? index,  String? family,  int? speed, @JsonKey(name: 'perm_address')  String? permAddress,  String? ifname,  int? txqlen,  int? linkmode,  int? mtu, @JsonKey(name: 'min_mtu')  int? minMtu, @JsonKey(name: 'max_mtu')  int? maxMtu,  int? group,  int? promiscuity,  List<int>? unknown, @JsonKey(name: 'num_tx_queues')  int? numTxQueues, @JsonKey(name: 'num_rx_queues')  int? numRxQueues, @JsonKey(name: 'gso_max_segs')  int? gsoMaxSegs, @JsonKey(name: 'gso_max_size')  int? gsoMaxSize,  int? map, @JsonKey(name: 'carrier_changes')  int? carrierChanges, @JsonKey(name: 'carrier_up_count')  int? carrierUpCount, @JsonKey(name: 'carrier_down_count')  int? carrierDownCount, @JsonKey(name: 'link_kind')  String? linkKind,  String? qdisc, @JsonKey(name: 'parent_dev_name')  String? parentDevName, @JsonKey(name: 'parent_dev_bus_name')  String? parentDevBusName)  $default,) {final _that = this;
switch (_that) {
case _InterfaceData():
return $default(_that.name,_that.type,_that.flags,_that.state,_that.protoDown,_that.address,_that.broadcast,_that.carrier,_that.stats,_that.addresses,_that.index,_that.family,_that.speed,_that.permAddress,_that.ifname,_that.txqlen,_that.linkmode,_that.mtu,_that.minMtu,_that.maxMtu,_that.group,_that.promiscuity,_that.unknown,_that.numTxQueues,_that.numRxQueues,_that.gsoMaxSegs,_that.gsoMaxSize,_that.map,_that.carrierChanges,_that.carrierUpCount,_that.carrierDownCount,_that.linkKind,_that.qdisc,_that.parentDevName,_that.parentDevBusName);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  String type,  List<String> flags,  String state, @JsonKey(name: 'proto_down')  bool protoDown,  String address,  String broadcast,  bool carrier,  InterfaceStats stats,  List<InterfaceAddress> addresses,  int? index,  String? family,  int? speed, @JsonKey(name: 'perm_address')  String? permAddress,  String? ifname,  int? txqlen,  int? linkmode,  int? mtu, @JsonKey(name: 'min_mtu')  int? minMtu, @JsonKey(name: 'max_mtu')  int? maxMtu,  int? group,  int? promiscuity,  List<int>? unknown, @JsonKey(name: 'num_tx_queues')  int? numTxQueues, @JsonKey(name: 'num_rx_queues')  int? numRxQueues, @JsonKey(name: 'gso_max_segs')  int? gsoMaxSegs, @JsonKey(name: 'gso_max_size')  int? gsoMaxSize,  int? map, @JsonKey(name: 'carrier_changes')  int? carrierChanges, @JsonKey(name: 'carrier_up_count')  int? carrierUpCount, @JsonKey(name: 'carrier_down_count')  int? carrierDownCount, @JsonKey(name: 'link_kind')  String? linkKind,  String? qdisc, @JsonKey(name: 'parent_dev_name')  String? parentDevName, @JsonKey(name: 'parent_dev_bus_name')  String? parentDevBusName)?  $default,) {final _that = this;
switch (_that) {
case _InterfaceData() when $default != null:
return $default(_that.name,_that.type,_that.flags,_that.state,_that.protoDown,_that.address,_that.broadcast,_that.carrier,_that.stats,_that.addresses,_that.index,_that.family,_that.speed,_that.permAddress,_that.ifname,_that.txqlen,_that.linkmode,_that.mtu,_that.minMtu,_that.maxMtu,_that.group,_that.promiscuity,_that.unknown,_that.numTxQueues,_that.numRxQueues,_that.gsoMaxSegs,_that.gsoMaxSize,_that.map,_that.carrierChanges,_that.carrierUpCount,_that.carrierDownCount,_that.linkKind,_that.qdisc,_that.parentDevName,_that.parentDevBusName);case _:
  return null;
...
@override@JsonKey(name: 'proto_down') final  bool protoDown;
...
@override@JsonKey(name: 'perm_address') final  String? permAddress;
@override final  String? ifname;
@override final  int? txqlen;
@override final  int? linkmode;
@override final  int? mtu;
@override@JsonKey(name: 'min_mtu') final  int? minMtu;
@override@JsonKey(name: 'max_mtu') final  int? maxMtu;
...
@override@JsonKey(name: 'num_tx_queues') final  int? numTxQueues;
@override@JsonKey(name: 'num_rx_queues') final  int? numRxQueues;
@override@JsonKey(name: 'gso_max_segs') final  int? gsoMaxSegs;
@override@JsonKey(name: 'gso_max_size') final  int? gsoMaxSize;
@override final  int? map;
@override@JsonKey(name: 'carrier_changes') final  int? carrierChanges;
@override@JsonKey(name: 'carrier_up_count') final  int? carrierUpCount;
@override@JsonKey(name: 'carrier_down_count') final  int? carrierDownCount;
@override@JsonKey(name: 'link_kind') final  String? linkKind;
@override final  String? qdisc;
@override@JsonKey(name: 'parent_dev_name') final  String? parentDevName;
@override@JsonKey(name: 'parent_dev_bus_name') final  String? parentDevBusName;

/// Create a copy of InterfaceData
/// with the given fields replaced by the non-null parameter values.
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$InterfaceDataCopyWith<_InterfaceData> get copyWith => __$InterfaceDataCopyWithImpl<_InterfaceData>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$InterfaceDataToJson(this, );
}
...
/// @nodoc
abstract mixin class _$InterfaceDataCopyWith<$Res> implements $InterfaceDataCopyWith<$Res> {
  factory _$InterfaceDataCopyWith(_InterfaceData value, $Res Function(_InterfaceData) _then) = __$InterfaceDataCopyWithImpl;
@override @useResult
$Res call({
 String name, String type, List<String> flags, String state,@JsonKey(name: 'proto_down') bool protoDown, String address, String broadcast, bool carrier, InterfaceStats stats, List<InterfaceAddress> addresses, int? index, String? family, int? speed,@JsonKey(name: 'perm_address') String? permAddress, String? ifname, int? txqlen, int? linkmode, int? mtu,@JsonKey(name: 'min_mtu') int? minMtu,@JsonKey(name: 'max_mtu') int? maxMtu, int? group, int? promiscuity, List<int>? unknown,@JsonKey(name: 'num_tx_queues') int? numTxQueues,@JsonKey(name: 'num_rx_queues') int? numRxQueues,@JsonKey(name: 'gso_max_segs') int? gsoMaxSegs,@JsonKey(name: 'gso_max_size') int? gsoMaxSize, int? map,@JsonKey(name: 'carrier_changes') int? carrierChanges,@JsonKey(name: 'carrier_up_count') int? carrierUpCount,@JsonKey(name: 'carrier_down_count') int? carrierDownCount,@JsonKey(name: 'link_kind') String? linkKind, String? qdisc,@JsonKey(name: 'parent_dev_name') String? parentDevName,@JsonKey(name: 'parent_dev_bus_name') String? parentDevBusName
});
...
@JsonKey(name: 'rx_bytes') ByteValue get rxBytes;@JsonKey(name: 'tx_bytes') ByteValue get txBytes; int get bits;@JsonKey(name: 'rx_packets') int get rxPackets;@JsonKey(name: 'tx_packets') int get txPackets;@JsonKey(name: 'rx_errors') int get rxErrors;@JsonKey(name: 'tx_errors') int get txErrors;@JsonKey(name: 'rx_dropped') int get rxDropped;@JsonKey(name: 'tx_dropped') int get txDropped; int get multicast; int get collisions;@JsonKey(name: 'rx_length_errors') int get rxLengthErrors;@JsonKey(name: 'rx_over_errors') int get rxOverErrors;@JsonKey(name: 'rx_crc_errors') int get rxCrcErrors;@JsonKey(name: 'rx_frame_errors') int get rxFrameErrors;@JsonKey(name: 'rx_fifo_errors') int get rxFifoErrors;@JsonKey(name: 'rx_missed_errors') int get rxMissedErrors;@JsonKey(name: 'tx_aborted_errors') int get txAbortedErrors;@JsonKey(name: 'tx_carrier_errors') int get txCarrierErrors;@JsonKey(name: 'tx_fifo_errors') int get txFifoErrors;@JsonKey(name: 'tx_heartbeat_errors') int get txHeartbeatErrors;@JsonKey(name: 'tx_window_errors') int get txWindowErrors;@JsonKey(name: 'rx_compressed') int get rxCompressed;@JsonKey(name: 'tx_compressed') int get txCompressed;@JsonKey(name: 'rx_nohandler') int get rxNohandler;
...
@useResult
$Res call({
@JsonKey(name: 'rx_bytes') ByteValue rxBytes,@JsonKey(name: 'tx_bytes') ByteValue txBytes, int bits,@JsonKey(name: 'rx_packets') int rxPackets,@JsonKey(name: 'tx_packets') int txPackets,@JsonKey(name: 'rx_errors') int rxErrors,@JsonKey(name: 'tx_errors') int txErrors,@JsonKey(name: 'rx_dropped') int rxDropped,@JsonKey(name: 'tx_dropped') int txDropped, int multicast, int collisions,@JsonKey(name: 'rx_length_errors') int rxLengthErrors,@JsonKey(name: 'rx_over_errors') int rxOverErrors,@JsonKey(name: 'rx_crc_errors') int rxCrcErrors,@JsonKey(name: 'rx_frame_errors') int rxFrameErrors,@JsonKey(name: 'rx_fifo_errors') int rxFifoErrors,@JsonKey(name: 'rx_missed_errors') int rxMissedErrors,@JsonKey(name: 'tx_aborted_errors') int txAbortedErrors,@JsonKey(name: 'tx_carrier_errors') int txCarrierErrors,@JsonKey(name: 'tx_fifo_errors') int txFifoErrors,@JsonKey(name: 'tx_heartbeat_errors') int txHeartbeatErrors,@JsonKey(name: 'tx_window_errors') int txWindowErrors,@JsonKey(name: 'rx_compressed') int rxCompressed,@JsonKey(name: 'tx_compressed') int txCompressed,@JsonKey(name: 'rx_nohandler') int rxNohandler
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'rx_bytes')  ByteValue rxBytes, @JsonKey(name: 'tx_bytes')  ByteValue txBytes,  int bits, @JsonKey(name: 'rx_packets')  int rxPackets, @JsonKey(name: 'tx_packets')  int txPackets, @JsonKey(name: 'rx_errors')  int rxErrors, @JsonKey(name: 'tx_errors')  int txErrors, @JsonKey(name: 'rx_dropped')  int rxDropped, @JsonKey(name: 'tx_dropped')  int txDropped,  int multicast,  int collisions, @JsonKey(name: 'rx_length_errors')  int rxLengthErrors, @JsonKey(name: 'rx_over_errors')  int rxOverErrors, @JsonKey(name: 'rx_crc_errors')  int rxCrcErrors, @JsonKey(name: 'rx_frame_errors')  int rxFrameErrors, @JsonKey(name: 'rx_fifo_errors')  int rxFifoErrors, @JsonKey(name: 'rx_missed_errors')  int rxMissedErrors, @JsonKey(name: 'tx_aborted_errors')  int txAbortedErrors, @JsonKey(name: 'tx_carrier_errors')  int txCarrierErrors, @JsonKey(name: 'tx_fifo_errors')  int txFifoErrors, @JsonKey(name: 'tx_heartbeat_errors')  int txHeartbeatErrors, @JsonKey(name: 'tx_window_errors')  int txWindowErrors, @JsonKey(name: 'rx_compressed')  int rxCompressed, @JsonKey(name: 'tx_compressed')  int txCompressed, @JsonKey(name: 'rx_nohandler')  int rxNohandler)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _InterfaceStats() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'rx_bytes')  ByteValue rxBytes, @JsonKey(name: 'tx_bytes')  ByteValue txBytes,  int bits, @JsonKey(name: 'rx_packets')  int rxPackets, @JsonKey(name: 'tx_packets')  int txPackets, @JsonKey(name: 'rx_errors')  int rxErrors, @JsonKey(name: 'tx_errors')  int txErrors, @JsonKey(name: 'rx_dropped')  int rxDropped, @JsonKey(name: 'tx_dropped')  int txDropped,  int multicast,  int collisions, @JsonKey(name: 'rx_length_errors')  int rxLengthErrors, @JsonKey(name: 'rx_over_errors')  int rxOverErrors, @JsonKey(name: 'rx_crc_errors')  int rxCrcErrors, @JsonKey(name: 'rx_frame_errors')  int rxFrameErrors, @JsonKey(name: 'rx_fifo_errors')  int rxFifoErrors, @JsonKey(name: 'rx_missed_errors')  int rxMissedErrors, @JsonKey(name: 'tx_aborted_errors')  int txAbortedErrors, @JsonKey(name: 'tx_carrier_errors')  int txCarrierErrors, @JsonKey(name: 'tx_fifo_errors')  int txFifoErrors, @JsonKey(name: 'tx_heartbeat_errors')  int txHeartbeatErrors, @JsonKey(name: 'tx_window_errors')  int txWindowErrors, @JsonKey(name: 'rx_compressed')  int rxCompressed, @JsonKey(name: 'tx_compressed')  int txCompressed, @JsonKey(name: 'rx_nohandler')  int rxNohandler)  $default,) {final _that = this;
switch (_that) {
case _InterfaceStats():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'rx_bytes')  ByteValue rxBytes, @JsonKey(name: 'tx_bytes')  ByteValue txBytes,  int bits, @JsonKey(name: 'rx_packets')  int rxPackets, @JsonKey(name: 'tx_packets')  int txPackets, @JsonKey(name: 'rx_errors')  int rxErrors, @JsonKey(name: 'tx_errors')  int txErrors, @JsonKey(name: 'rx_dropped')  int rxDropped, @JsonKey(name: 'tx_dropped')  int txDropped,  int multicast,  int collisions, @JsonKey(name: 'rx_length_errors')  int rxLengthErrors, @JsonKey(name: 'rx_over_errors')  int rxOverErrors, @JsonKey(name: 'rx_crc_errors')  int rxCrcErrors, @JsonKey(name: 'rx_frame_errors')  int rxFrameErrors, @JsonKey(name: 'rx_fifo_errors')  int rxFifoErrors, @JsonKey(name: 'rx_missed_errors')  int rxMissedErrors, @JsonKey(name: 'tx_aborted_errors')  int txAbortedErrors, @JsonKey(name: 'tx_carrier_errors')  int txCarrierErrors, @JsonKey(name: 'tx_fifo_errors')  int txFifoErrors, @JsonKey(name: 'tx_heartbeat_errors')  int txHeartbeatErrors, @JsonKey(name: 'tx_window_errors')  int txWindowErrors, @JsonKey(name: 'rx_compressed')  int rxCompressed, @JsonKey(name: 'tx_compressed')  int txCompressed, @JsonKey(name: 'rx_nohandler')  int rxNohandler)?  $default,) {final _that = this;
switch (_that) {
case _InterfaceStats() when $default != null:
return $default(_that.rxBytes,_that.txBytes,_that.bits,_that.rxPackets,_that.txPackets,_that.rxErrors,_that.txErrors,_that.rxDropped,_that.txDropped,_that.multicast,_that.collisions,_that.rxLengthErrors,_that.rxOverErrors,_that.rxCrcErrors,_that.rxFrameErrors,_that.rxFifoErrors,_that.rxMissedErrors,_that.txAbortedErrors,_that.txCarrierErrors,_that.txFifoErrors,_that.txHeartbeatErrors,_that.txWindowErrors,_that.rxCompressed,_that.txCompressed,_that.rxNohandler);case _:
  return null;
...
class _InterfaceStats implements InterfaceStats {
  const _InterfaceStats({@JsonKey(name: 'rx_bytes') required this.rxBytes, @JsonKey(name: 'tx_bytes') required this.txBytes, required this.bits, @JsonKey(name: 'rx_packets') required this.rxPackets, @JsonKey(name: 'tx_packets') required this.txPackets, @JsonKey(name: 'rx_errors') required this.rxErrors, @JsonKey(name: 'tx_errors') required this.txErrors, @JsonKey(name: 'rx_dropped') required this.rxDropped, @JsonKey(name: 'tx_dropped') required this.txDropped, required this.multicast, required this.collisions, @JsonKey(name: 'rx_length_errors') required this.rxLengthErrors, @JsonKey(name: 'rx_over_errors') required this.rxOverErrors, @JsonKey(name: 'rx_crc_errors') required this.rxCrcErrors, @JsonKey(name: 'rx_frame_errors') required this.rxFrameErrors, @JsonKey(name: 'rx_fifo_errors') required this.rxFifoErrors, @JsonKey(name: 'rx_missed_errors') required this.rxMissedErrors, @JsonKey(name: 'tx_aborted_errors') required this.txAbortedErrors, @JsonKey(name: 'tx_carrier_errors') required this.txCarrierErrors, @JsonKey(name: 'tx_fifo_errors') required this.txFifoErrors, @JsonKey(name: 'tx_heartbeat_errors') required this.txHeartbeatErrors, @JsonKey(name: 'tx_window_errors') required this.txWindowErrors, @JsonKey(name: 'rx_compressed') required this.rxCompressed, @JsonKey(name: 'tx_compressed') required this.txCompressed, @JsonKey(name: 'rx_nohandler') required this.rxNohandler});
  factory _InterfaceStats.fromJson(Map<String, dynamic> json) => _$InterfaceStatsFromJson(json);

@override@JsonKey(name: 'rx_bytes') final  ByteValue rxBytes;
@override@JsonKey(name: 'tx_bytes') final  ByteValue txBytes;
@override final  int bits;
@override@JsonKey(name: 'rx_packets') final  int rxPackets;
@override@JsonKey(name: 'tx_packets') final  int txPackets;
@override@JsonKey(name: 'rx_errors') final  int rxErrors;
@override@JsonKey(name: 'tx_errors') final  int txErrors;
@override@JsonKey(name: 'rx_dropped') final  int rxDropped;
@override@JsonKey(name: 'tx_dropped') final  int txDropped;
@override final  int multicast;
@override final  int collisions;
@override@JsonKey(name: 'rx_length_errors') final  int rxLengthErrors;
@override@JsonKey(name: 'rx_over_errors') final  int rxOverErrors;
@override@JsonKey(name: 'rx_crc_errors') final  int rxCrcErrors;
@override@JsonKey(name: 'rx_frame_errors') final  int rxFrameErrors;
@override@JsonKey(name: 'rx_fifo_errors') final  int rxFifoErrors;
@override@JsonKey(name: 'rx_missed_errors') final  int rxMissedErrors;
@override@JsonKey(name: 'tx_aborted_errors') final  int txAbortedErrors;
@override@JsonKey(name: 'tx_carrier_errors') final  int txCarrierErrors;
@override@JsonKey(name: 'tx_fifo_errors') final  int txFifoErrors;
@override@JsonKey(name: 'tx_heartbeat_errors') final  int txHeartbeatErrors;
@override@JsonKey(name: 'tx_window_errors') final  int txWindowErrors;
@override@JsonKey(name: 'rx_compressed') final  int rxCompressed;
@override@JsonKey(name: 'tx_compressed') final  int txCompressed;
@override@JsonKey(name: 'rx_nohandler') final  int rxNohandler;
...
@override@JsonKey(name: 'local_type') final  String? localType;
@override final  String? broadcast;
@override@JsonKey(name: 'broadcast_type') final  String? broadcastType;
 final  List<int>? _unknown;
@override List<int>? get unknown {
  final value = _unknown;
  if (value == null) return null;
