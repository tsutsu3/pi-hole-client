...
@useResult
$Res call({
 List<GatewayData> gateway, double took, List<InterfaceData>? interfaces, List<RouteData>? routes
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<GatewayData> gateway,  double took,  List<InterfaceData>? interfaces,  List<RouteData>? routes)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Gateway() when $default != null:
return $default(_that.gateway,_that.took,_that.interfaces,_that.routes);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<GatewayData> gateway,  double took,  List<InterfaceData>? interfaces,  List<RouteData>? routes)  $default,) {final _that = this;
switch (_that) {
case _Gateway():
return $default(_that.gateway,_that.took,_that.interfaces,_that.routes);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<GatewayData> gateway,  double took,  List<InterfaceData>? interfaces,  List<RouteData>? routes)?  $default,) {final _that = this;
switch (_that) {
case _Gateway() when $default != null:
return $default(_that.gateway,_that.took,_that.interfaces,_that.routes);case _:
  return null;
...
/// Create a copy of Gateway
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? gateway = null,Object? took = null,Object? interfaces = freezed,Object? routes = freezed,}) {
