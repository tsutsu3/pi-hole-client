...
mixin _$Gateway {
 ...
 List<GatewayData> get gateways; double get took; List<InterfaceData>? get interfaces; List<RouteData>? get routes;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Gateway&&const DeepCollectionEquality().equals(other.gateways, gateways)&&(identical(other.took, took) || other.took == took)&&const DeepCollectionEquality().equals(other.interfaces, interfaces)&&const DeepCollectionEquality().equals(other.routes, routes));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(gateways),took,const DeepCollectionEquality().hash(interfaces),const DeepCollectionEquality().hash(routes));

@override
String toString() {
  return 'Gateway(gateways: $gateways, took: $took, interfaces: $interfaces, routes: $routes)';
}
...
@useResult
$Res call({
 List<GatewayData> gateways, double took, List<InterfaceData>? interfaces, List<RouteData>? routes
});
...
/// Create a copy of Gateway
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? gateways = null,Object? took = null,Object? interfaces = freezed,Object? routes = freezed,}) {
...
as List<InterfaceData>?,routes: freezed == routes ? _self.routes : routes // ignore: cast_nullable_to_non_nullable
as List<RouteData>?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<GatewayData> gateways,  double took,  List<InterfaceData>? interfaces,  List<RouteData>? routes)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Gateway() when $default != null:
return $default(_that.gateways,_that.took,_that.interfaces,_that.routes);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<GatewayData> gateways,  double took,  List<InterfaceData>? interfaces,  List<RouteData>? routes)  $default,) {final _that = this;
switch (_that) {
case _Gateway():
return $default(_that.gateways,_that.took,_that.interfaces,_that.routes);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<GatewayData> gateways,  double took,  List<InterfaceData>? interfaces,  List<RouteData>? routes)?  $default,) {final _that = this;
switch (_that) {
case _Gateway() when $default != null:
return $default(_that.gateways,_that.took,_that.interfaces,_that.routes);case _:
  return null;
...
class _Gateway implements Gateway {
  const _Gateway({required final  List<GatewayData> gateways, required this.took, final  List<InterfaceData>? interfaces, final  List<RouteData>? routes}): _gateways = gateways,_interfaces = interfaces,_routes = routes;
  factory _Gateway.fromJson(Map<String, dynamic> json) => _$GatewayFromJson(json);

 final  List<GatewayData> _gateways;
@override List<GatewayData> get gateways {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Gateway&&const DeepCollectionEquality().equals(other._gateways, _gateways)&&(identical(other.took, took) || other.took == took)&&const DeepCollectionEquality().equals(other._interfaces, _interfaces)&&const DeepCollectionEquality().equals(other._routes, _routes));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_gateways),took,const DeepCollectionEquality().hash(_interfaces),const DeepCollectionEquality().hash(_routes));
...
/// Create a copy of Gateway
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? gateways = null,Object? took = null,Object? interfaces = freezed,Object? routes = freezed,}) {
  return _then(_Gateway(
gateways: null == gateways ? _self._gateways : gateways // ignore: cast_nullable_to_non_nullable
as List<GatewayData>,took: null == took ? _self.took : took // ignore: cast_nullable_to_non_nullable
as double,interfaces: freezed == interfaces ? _self._interfaces : interfaces // ignore: cast_nullable_to_non_nullable
as List<InterfaceData>?,routes: freezed == routes ? _self._routes : routes // ignore: cast_nullable_to_non_nullable
as List<RouteData>?,
  ));
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$GatewayDataCopyWith<GatewayData> get copyWith => _$GatewayDataCopyWithImpl<GatewayData>(this as GatewayData, _$identity);
...
abstract mixin class $GatewayDataCopyWith<$Res>  {
  factory $GatewayDataCopyWith(GatewayData value, $Res Function(GatewayData) _then) = _$GatewayDataCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$GatewayDataCopyWithImpl<$Res>
...
/// Adds pattern-matching-related methods to [GatewayData].
extension GatewayDataPatterns on GatewayData {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _GatewayData value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _GatewayData() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _GatewayData value)  $default,){
final _that = this;
switch (_that) {
case _GatewayData():
return $default(_that);}
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _GatewayData value)?  $default,){
final _that = this;
switch (_that) {
case _GatewayData() when $default != null:
return $default(_that);case _:
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$GatewayDataCopyWith<_GatewayData> get copyWith => __$GatewayDataCopyWithImpl<_GatewayData>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$GatewayDataToJson(this, );
}
...
/// @nodoc
abstract mixin class _$GatewayDataCopyWith<$Res> implements $GatewayDataCopyWith<$Res> {
  factory _$GatewayDataCopyWith(_GatewayData value, $Res Function(_GatewayData) _then) = __$GatewayDataCopyWithImpl;
@override @useResult
$Res call({
 String family, String interface, String address, List<String> local
});
...
/// @nodoc
class __$GatewayDataCopyWithImpl<$Res>
    implements _$GatewayDataCopyWith<$Res> {
