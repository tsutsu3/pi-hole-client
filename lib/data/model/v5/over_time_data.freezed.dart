...
@JsonKey(name: 'domains_over_time') Map<String, int> get domainsOverTime;@JsonKey(name: 'ads_over_time') Map<String, int> get adsOverTime;@MapOrEmptyListConverter() List<Client> get clients;@JsonKey(name: 'over_time')@MapListOrEmptyListConverter() Map<String, List<int>> get overTime;
/// Create a copy of OverTimeData
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$OverTimeDataCopyWith<OverTimeData> get copyWith => _$OverTimeDataCopyWithImpl<OverTimeData>(this as OverTimeData, _$identity);
...
abstract mixin class $OverTimeDataCopyWith<$Res>  {
  factory $OverTimeDataCopyWith(OverTimeData value, $Res Function(OverTimeData) _then) = _$OverTimeDataCopyWithImpl;
@useResult
$Res call({
@JsonKey(name: 'domains_over_time') Map<String, int> domainsOverTime,@JsonKey(name: 'ads_over_time') Map<String, int> adsOverTime,@MapOrEmptyListConverter() List<Client> clients,@JsonKey(name: 'over_time')@MapListOrEmptyListConverter() Map<String, List<int>> overTime
});
...
/// @nodoc
class _$OverTimeDataCopyWithImpl<$Res>
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _OverTimeData value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _OverTimeData value)  $default,){
final _that = this;
switch (_that) {
case _OverTimeData():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _OverTimeData value)?  $default,){
final _that = this;
switch (_that) {
case _OverTimeData() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'domains_over_time')  Map<String, int> domainsOverTime, @JsonKey(name: 'ads_over_time')  Map<String, int> adsOverTime, @MapOrEmptyListConverter()  List<Client> clients, @JsonKey(name: 'over_time')@MapListOrEmptyListConverter()  Map<String, List<int>> overTime)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _OverTimeData() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'domains_over_time')  Map<String, int> domainsOverTime, @JsonKey(name: 'ads_over_time')  Map<String, int> adsOverTime, @MapOrEmptyListConverter()  List<Client> clients, @JsonKey(name: 'over_time')@MapListOrEmptyListConverter()  Map<String, List<int>> overTime)  $default,) {final _that = this;
switch (_that) {
case _OverTimeData():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'domains_over_time')  Map<String, int> domainsOverTime, @JsonKey(name: 'ads_over_time')  Map<String, int> adsOverTime, @MapOrEmptyListConverter()  List<Client> clients, @JsonKey(name: 'over_time')@MapListOrEmptyListConverter()  Map<String, List<int>> overTime)?  $default,) {final _that = this;
switch (_that) {
case _OverTimeData() when $default != null:
return $default(_that.domainsOverTime,_that.adsOverTime,_that.clients,_that.overTime);case _:
  return null;
...
@override@JsonKey(name: 'domains_over_time') Map<String, int> get domainsOverTime {
...
@override@JsonKey(name: 'ads_over_time') Map<String, int> get adsOverTime {
...
@override@MapOrEmptyListConverter() List<Client> get clients {
...
@override@JsonKey(name: 'over_time')@MapListOrEmptyListConverter() Map<String, List<int>> get overTime {
...
@pragma('vm:prefer-inline')
_$OverTimeDataCopyWith<_OverTimeData> get copyWith => __$OverTimeDataCopyWithImpl<_OverTimeData>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$OverTimeDataToJson(this, );
}
...
/// @nodoc
abstract mixin class _$OverTimeDataCopyWith<$Res> implements $OverTimeDataCopyWith<$Res> {
  factory _$OverTimeDataCopyWith(_OverTimeData value, $Res Function(_OverTimeData) _then) = __$OverTimeDataCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: 'domains_over_time') Map<String, int> domainsOverTime,@JsonKey(name: 'ads_over_time') Map<String, int> adsOverTime,@MapOrEmptyListConverter() List<Client> clients,@JsonKey(name: 'over_time')@MapListOrEmptyListConverter() Map<String, List<int>> overTime
});
...
as Map<String, int>,adsOverTime: null == adsOverTime ? _self._adsOverTime : adsOverTime // ignore: cast_nullable_to_non_nullable
as Map<String, int>,clients: null == clients ? _self._clients : clients // ignore: cast_nullable_to_non_nullable
