...
extension RouteFamilyMapper on s.RouteFamily {
  d.RouteFamily toDomain() {
    switch (this) {
      case s.RouteFamily.inet:
        return d.RouteFamily.inet;
      case s.RouteFamily.inet6:
        return d.RouteFamily.inet6;
      case s.RouteFamily.link:
        return d.RouteFamily.link;
      case s.RouteFamily.mpls:
        return d.RouteFamily.mpls;
      case s.RouteFamily.bridge:
        return d.RouteFamily.bridge;
      case s.RouteFamily.unknown:
        return d.RouteFamily.unknown;
    }
  }
}
