import 'package:pi_hole_client/data/services/api/model/v6/ftl/client.dart' as s;
import 'package:pi_hole_client/data/services/api/model/v6/ftl/ftl.dart' as s;
import 'package:pi_hole_client/data/services/api/model/v6/ftl/host.dart' as s;
...
import 'package:pi_hole_client/data/services/api/model/v6/ftl/sensors.dart'
    as s;
import 'package:pi_hole_client/data/services/api/model/v6/ftl/system.dart' as s;
import 'package:pi_hole_client/data/services/api/model/v6/ftl/version.dart'
    as s;
import 'package:pi_hole_client/domain/models/ftl/client.dart' as d;
import 'package:pi_hole_client/domain/models/ftl/ftl.dart' as d;
import 'package:pi_hole_client/domain/models/ftl/host.dart' as d;
import 'package:pi_hole_client/domain/models/ftl/message.dart' as d;
import 'package:pi_hole_client/domain/models/ftl/metrics.dart' as d;
import 'package:pi_hole_client/domain/models/ftl/sensor.dart' as d;
import 'package:pi_hole_client/domain/models/ftl/system.dart' as d;
import 'package:pi_hole_client/domain/models/ftl/version.dart' as d;
