...
abstract interface class ApiGateway {
  ...
  Future<DomainResponse> updateDomain({required DomainRequest body});
  ...
  Future<SubscriptionsResponse> getSubscriptions({String? url, String? stype});
  ...
  Future<DevicesResponse> getDevices({int? maxDevices, int? maxAddresses});
