...
$AdlistCopyWith<Adlist> get copyWith => _$AdlistCopyWithImpl<Adlist>(this as Adlist, _$identity);
...
/// @nodoc
class _$AdlistCopyWithImpl<$Res>
    implements $AdlistCopyWith<$Res> {
...
as DateTime,dateUpdated: null == dateUpdated ? _self.dateUpdated : dateUpdated // ignore: cast_nullable_to_non_nullable
...
as ListsStatus,comment: freezed == comment ? _self.comment : comment // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _Adlist value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _Adlist value)  $default,){
final _that = this;
switch (_that) {
case _Adlist():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _Adlist value)?  $default,){
final _that = this;
switch (_that) {
case _Adlist() when $default != null:
return $default(_that);case _:
...
@override final  int invalidDomains;
@override final  int abpEntries;
@override final  ListsStatus status;
...
@pragma('vm:prefer-inline')
_$AdlistCopyWith<_Adlist> get copyWith => __$AdlistCopyWithImpl<_Adlist>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$AdlistToJson(this, );
}
...
/// @nodoc
class __$AdlistCopyWithImpl<$Res>
    implements _$AdlistCopyWith<$Res> {
