...
abstract mixin class $BlockingCopyWith<$Res> {
  ...
  @useResult
  $Res call({DnsBlockingStatus status, int? timer, double took});
}
...
extension BlockingPatterns on Blocking {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(DnsBlockingStatus status, int? timer, double took)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
...
class _Blocking implements Blocking {
  ...
  @override
  final DnsBlockingStatus status;
  @override
  final int? timer;
  @override
  final double took;
