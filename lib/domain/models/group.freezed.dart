...
mixin _$Group {
  ...
  int get hashCode => Object.hash(
      runtimeType, id, name, enabled, dateAdded, dateModified, comment);
...
extension GroupPatterns on Group {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(int id, String name, bool enabled, DateTime dateAdded,
            DateTime dateModified, String? comment)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Group() when $default != null:
        return $default(_that.id, _that.name, _that.enabled, _that.dateAdded,
