...
class _Auth implements Auth {
   _Auth({required this.valid, required this.totp, required this.sid, required this.csrf, required this.validity, required this.message});
...
mixin _$AuthSession {
 ...
 int get id; bool get isValid; bool get isCurrentSession; TlsStatus get tlsStatus; bool get isApp; bool get isCli; DateTime get loginAt; DateTime get lastActive; DateTime get validUntil; String get clientIp; String? get userAgent;
...
@useResult
$Res call({
 int id, bool isValid, bool isCurrentSession, TlsStatus tlsStatus, bool isApp, bool isCli, DateTime loginAt, DateTime lastActive, DateTime validUntil, String clientIp, String? userAgent
});
...
as bool,tlsStatus: null == tlsStatus ? _self.tlsStatus : tlsStatus // ignore: cast_nullable_to_non_nullable
as TlsStatus,isApp: null == isApp ? _self.isApp : isApp // ignore: cast_nullable_to_non_nullable
as bool,isCli: null == isCli ? _self.isCli : isCli // ignore: cast_nullable_to_non_nullable
...
as DateTime,clientIp: null == clientIp ? _self.clientIp : clientIp // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  bool isValid,  bool isCurrentSession,  TlsStatus tlsStatus,  bool isApp,  bool isCli,  DateTime loginAt,  DateTime lastActive,  DateTime validUntil,  String clientIp,  String? userAgent)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthSession() when $default != null:
return $default(_that.id,_that.isValid,_that.isCurrentSession,_that.tlsStatus,_that.isApp,_that.isCli,_that.loginAt,_that.lastActive,_that.validUntil,_that.clientIp,_that.userAgent);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  bool isValid,  bool isCurrentSession,  TlsStatus tlsStatus,  bool isApp,  bool isCli,  DateTime loginAt,  DateTime lastActive,  DateTime validUntil,  String clientIp,  String? userAgent)  $default,) {final _that = this;
switch (_that) {
case _AuthSession():
return $default(_that.id,_that.isValid,_that.isCurrentSession,_that.tlsStatus,_that.isApp,_that.isCli,_that.loginAt,_that.lastActive,_that.validUntil,_that.clientIp,_that.userAgent);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  bool isValid,  bool isCurrentSession,  TlsStatus tlsStatus,  bool isApp,  bool isCli,  DateTime loginAt,  DateTime lastActive,  DateTime validUntil,  String clientIp,  String? userAgent)?  $default,) {final _that = this;
switch (_that) {
case _AuthSession() when $default != null:
return $default(_that.id,_that.isValid,_that.isCurrentSession,_that.tlsStatus,_that.isApp,_that.isCli,_that.loginAt,_that.lastActive,_that.validUntil,_that.clientIp,_that.userAgent);case _:
  return null;
...
class _AuthSession implements AuthSession {
  const _AuthSession({required this.id, required this.isValid, required this.isCurrentSession, required this.tlsStatus, required this.isApp, required this.isCli, required this.loginAt, required this.lastActive, required this.validUntil, required this.clientIp, this.userAgent});
  factory _AuthSession.fromJson(Map<String, dynamic> json) => _$AuthSessionFromJson(json);

@override final  int id;
@override final  bool isValid;
@override final  bool isCurrentSession;
@override final  TlsStatus tlsStatus;
@override final  bool isApp;
@override final  bool isCli;
...
/// Create a copy of AuthSession
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? isValid = null,Object? isCurrentSession = null,Object? tlsStatus = null,Object? isApp = null,Object? isCli = null,Object? loginAt = null,Object? lastActive = null,Object? validUntil = null,Object? clientIp = null,Object? userAgent = freezed,}) {
