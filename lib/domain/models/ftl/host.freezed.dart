...
mixin _$InfoHost {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, domainname, arch, hostName,
      release, sysName, version, model);
...
extension InfoHostPatterns on InfoHost {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String domainname, String arch, String hostName,
            String release, String sysName, String version, String? model)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _InfoHost() when $default != null:
        return $default(_that.domainname, _that.arch, _that.hostName,
            _that.release, _that.sysName, _that.version, _that.model);
      case _:
        return orElse();
    }
  }
