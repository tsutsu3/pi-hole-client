...
/// @nodoc
mixin _$InfoVersion {
  ComponentVersion get core;
  ComponentVersion get web;
  ComponentVersion get ftl;
  ComponentVersion get docker;
...
extension InfoVersionPatterns on InfoVersion {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(ComponentVersion core, ComponentVersion web,
            ComponentVersion ftl, ComponentVersion docker)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
...
mixin _$ComponentVersion {
  VersionDetail get local;
  VersionDetail get remote;

  /// Create a copy of ComponentVersion
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ComponentVersionCopyWith<ComponentVersion> get copyWith =>
      _$ComponentVersionCopyWithImpl<ComponentVersion>(
          this as ComponentVersion, _$identity);
  ...
  @override
  String toString() {
    return 'ComponentVersion(local: $local, remote: $remote)';
  }
}

/// @nodoc
abstract mixin class $ComponentVersionCopyWith<$Res> {
  factory $ComponentVersionCopyWith(
          ComponentVersion value, $Res Function(ComponentVersion) _then) =
      _$ComponentVersionCopyWithImpl;
  @useResult
  $Res call({VersionDetail local, VersionDetail remote});
...
extension ComponentVersionPatterns on ComponentVersion {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ComponentVersion value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(VersionDetail local, VersionDetail remote)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
@JsonSerializable(explicitToJson: true)
class _ComponentVersion extends ComponentVersion {
  const _ComponentVersion({required this.local, required this.remote})
      : super._();
  factory _ComponentVersion.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ComponentVersionCopyWith<_ComponentVersion> get copyWith =>
      __$ComponentVersionCopyWithImpl<_ComponentVersion>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ComponentVersionToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$ComponentVersionCopyWith<$Res>
    implements $ComponentVersionCopyWith<$Res> {
  factory _$ComponentVersionCopyWith(
          _ComponentVersion value, $Res Function(_ComponentVersion) _then) =
      __$ComponentVersionCopyWithImpl;
  @override
  @useResult
  $Res call({VersionDetail local, VersionDetail remote});
...
abstract mixin class $VersionDetailCopyWith<$Res> {
  ...
  @useResult
  $Res call({String version, String? branch, String? hash, String? date});
}
...
extension VersionDetailPatterns on VersionDetail {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_VersionDetail value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  @optionalTypeArgs
  TResult when<TResult extends Object?>(
    TResult Function(String version, String? branch, String? hash, String? date)
        $default,
  ) {
    final _that = this;
    switch (_that) {
...
class _VersionDetail implements VersionDetail {
  const _VersionDetail(
      {required this.version, this.branch, this.hash, this.date});
