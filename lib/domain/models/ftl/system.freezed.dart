...
mixin _$InfoSystem {
 ...
 int get uptime; double get ramUsage; double get cpuUsage;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is InfoSystem&&(identical(other.uptime, uptime) || other.uptime == uptime)&&(identical(other.ramUsage, ramUsage) || other.ramUsage == ramUsage)&&(identical(other.cpuUsage, cpuUsage) || other.cpuUsage == cpuUsage));
}
...
@useResult
$Res call({
 int uptime, double ramUsage, double cpuUsage
});
...
/// Create a copy of InfoSystem
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? uptime = null,Object? ramUsage = null,Object? cpuUsage = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int uptime,  double ramUsage,  double cpuUsage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _InfoSystem() when $default != null:
return $default(_that.uptime,_that.ramUsage,_that.cpuUsage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int uptime,  double ramUsage,  double cpuUsage)  $default,) {final _that = this;
switch (_that) {
case _InfoSystem():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int uptime,  double ramUsage,  double cpuUsage)?  $default,) {final _that = this;
switch (_that) {
case _InfoSystem() when $default != null:
return $default(_that.uptime,_that.ramUsage,_that.cpuUsage);case _:
  return null;
...
class _InfoSystem implements InfoSystem {
  const _InfoSystem({required this.uptime, required this.ramUsage, required this.cpuUsage});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _InfoSystem&&(identical(other.uptime, uptime) || other.uptime == uptime)&&(identical(other.ramUsage, ramUsage) || other.ramUsage == ramUsage)&&(identical(other.cpuUsage, cpuUsage) || other.cpuUsage == cpuUsage));
}
...
/// Create a copy of InfoSystem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? uptime = null,Object? ramUsage = null,Object? cpuUsage = null,}) {
