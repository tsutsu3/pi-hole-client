...
/// - If a time range filter is active (via [LogsViewModel]), it shows the range with no logs found.
...
class NoLogsMessage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final startTime = context.select<LogsViewModel, DateTime?>(
      (provider) => provider.startTime,
    );
    final endTime = context.select<LogsViewModel, DateTime?>(
