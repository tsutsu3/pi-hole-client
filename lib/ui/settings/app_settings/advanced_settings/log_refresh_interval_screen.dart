...
class LogRefreshIntervalScreen extends StatefulWidget {
  const LogRefreshIntervalScreen({super.key});

  @override
  State<LogRefreshIntervalScreen> createState() =>
      _LogRefreshIntervalScreenState();
}

class _LogRefreshIntervalScreenState extends State<LogRefreshIntervalScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final saved = configProvider.logAutoRefreshTime;
      setState(() {
  ...
  Future<void> _save() async {
    final time = _getTime();
    final result = await configProvider.setLogAutoRefreshTime(time);
