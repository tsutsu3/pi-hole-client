...
final kRepoFetchRealTimeStatus = repo.RealtimeStatus(
  ...
  topDomains: const repo.TopDomains(
    topQueries: [repo.QueryStat(domain: 'pi-hole.net', count: 8516)],
    topAds: [repo.QueryStat(domain: 'pi-hole.net', count: 8516)],
  ),
