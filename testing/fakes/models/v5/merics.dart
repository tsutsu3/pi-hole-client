...
const kSrvGetOverTimeData = srv.OverTimeData(
  domainsOverTime: {
    '1733391300': 0,
    '1733391900': 0,
    '1733392500': 0,
  ...
  clients: [
    srv.Client(name: '', ip: '172.26.0.1'),
    srv.Client(name: 'localhost', ip: '127.0.0.1'),
  ],
  overTime: {
    '1733391300': [0, 0],
    '1733391900': [0, 0],
...
// repo models
final kRepoFetchOverTime = kSrvGetOverTimeData.toDomain();
