...
connection to the server with different circunstances. These are the most common
...
- **Authentication**:
   - **v5**: Requires a API **token** (See: [Getting the API token (v5 only)](../get-api-token)).
