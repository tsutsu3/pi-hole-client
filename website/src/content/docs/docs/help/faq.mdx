...
<DocImage width="320" alt="Update pinned fingerprint dialog" src={imgCertUpdate} />
...
<DocImage width="320" alt="Widget offline state" src={imgWidgetOffline} />
...
:::note
Fixed in app v1.10.0

This was a regression in app versions **1.9.0, 1.9.1 and 1.9.2**. It is **fixed
in v1.10.0** — update the app if you are still on 1.9.x. Versions up to 1.8.0
are not affected.
:::
...
**Update the app to v1.10.0 or later.** From v1.10.0 the app accepts the empty
session and connects to a password-less Pi-hole v6.

If you cannot update yet, set a password on your Pi-hole and enter it in the app:
