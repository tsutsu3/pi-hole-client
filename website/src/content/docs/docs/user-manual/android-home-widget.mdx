...
<ImageRow>
  <img width="240" alt="Home Widget List" src={imageWidgetList.src} />
  <img width="240" alt="Home Widget Preview" src={imageWidgetPreview.src} />
  <img width="240" alt="All widgets with blocking enabled" src={imageWidgetOn.src} />
</ImageRow>
...
<img width="320" alt="Widget server selection screen" src={imageWidgetSelectServer.src} />
...
<img width="320" alt="Stats widget (large)" src={imageWidgetLarge.src} />

### Compact (Medium)

A balanced view showing key stats and toggle/refresh actions in a smaller footprint.

<img width="280" alt="Compact widget (medium)" src={imageWidgetMedium.src} />

### Toggle (Small)

Minimal widget focused on the toggle action. Shows status and blocking control only.

<img width="128" alt="Toggle widget (small)" src={imageWidgetSmall.src} />
...
<img width="320" alt="Widget offline state" src={imageWidgetOffline.src} />
