...
<DocImage priority width="320" alt="All certificate statuses" src={imgStatusAll} />
...
<DocImage width="512" alt="HTTPS Verified status" src={imgStatusVerify} />
...
<DocImage width="512" alt="HTTPS Pinned status" src={imgStatusPinned} />
...
<DocImage width="320" alt="Server menu with Update option" src={imgServerMenu} />
:::
...
<DocImage width="512" alt="Don't check SSL certificate status" src={imgStatusSkip} />
...
<DocImage width="512" alt="HTTPS Untrusted Allowed status" src={imgStatusUntrustedAllow} />
...
<DocImage width="512" alt="HTTP status" src={imgStatusHttp} />
...
<DocImage width="512" alt="HTTPS Pin Mismatch status" src={imgStatusMismatch} />
...
<DocImage width="512" alt="HTTPS Untrusted Blocked status" src={imgStatusBlock} />
...
<DocImage width="320" alt="Self-signed certificate setting" src={imgSelfSignedCert} />
...
<DocImage width="320" alt="Signed certificate setting" src={imgSignedCert} />
...
<DocImage width="320" alt="Warning banner after app update" src={imgWarningBar} />
...
<ImageRow>
  <DocImage width="240" alt="Self-signed certificate settings" src={imgSelfSignedCert} />
  <DocImage
    width="240"
...
<DocImage width="320" alt="Docker connection error" src={imgDockerError} />
...
<DocImage width="320" alt="Ignore certificate errors setting" src={imgIgnoreCertError} />
